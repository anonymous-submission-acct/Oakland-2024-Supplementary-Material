...
int OBF_FUNC(int number) {
  ...
  int tmp___45;
  int tmp___46;
  struct _2_OBF_FUNC_1_opaque_NodeStruct *p51;
  int i52;
  struct _2_OBF_FUNC_1_opaque_NodeStruct *p53;
  int _2_OBF_FUNC__BEGIN_1;
  int _2_OBF_FUNC__END_1;
  int _2_OBF_FUNC__BARRIER_2;
  struct _2_OBF_FUNC_2_opaque_NodeStruct *p57;
  int i58;
  struct _2_OBF_FUNC_2_opaque_NodeStruct *p59;
  ...
  {
    {
      ...
      p57 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
      p57->next = p57;
      p57->prev = p57;
      _2_OBF_FUNC_2_opaque_list_1 = p57;
      i58 = 0;
      while (i58 < 4) {
        p59 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p59->data = i58 * ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5));
        p59->next = _2_OBF_FUNC_2_opaque_list_1->next;
        p59->prev = _2_OBF_FUNC_2_opaque_list_1;
        (_2_OBF_FUNC_2_opaque_list_1->next)->prev = p59;
        _2_OBF_FUNC_2_opaque_list_1->next = p59;
        i58++;
      }
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p51 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
      p51->next = p51;
      p51->prev = p51;
      _2_OBF_FUNC_1_opaque_list_1 = p51;
      i52 = 0;
      while (i52 < 2) {
        p53 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p53->data = i52 * ((_1_entropy | 5) - (_1_entropy & 5));
        p53->next = _2_OBF_FUNC_1_opaque_list_1->next;
        p53->prev = _2_OBF_FUNC_1_opaque_list_1;
        (_2_OBF_FUNC_1_opaque_list_1->next)->prev = p53;
        _2_OBF_FUNC_1_opaque_list_1->next = p53;
        i52++;
      }
