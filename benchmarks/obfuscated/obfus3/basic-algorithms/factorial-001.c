...
unsigned long _2_entropy = 7214283585893980672UL;
...
long long OBF_FUNC(int n) {
  int __RANDVAR__4071167464721890002__;
  int __RANDVAR__74439043212919767364__;
  int __RANDVAR__22721814238328614580__;
  int count;
  long long factorial;
  int tmp;
  int tmp___0;
  int tmp___1;
  int __RANDVAR__36675624077747579388__;
  ...
  {
    {
      ...
      while (i19 < 4) {
        ...
        p20->data = i19 * (((_2_entropy - 3) - ((_2_entropy | ~3) + (_2_entropy | ~3))) - 2UL);
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * (((_2_entropy - 7) - ((_2_entropy | ~7) << 1UL)) - 2UL);
    ...
    while (1) {
      ...
      case 18:
        __RANDVAR__22721814238328614580__++;
      ...
      case 25:
        ...
        break;
      case 4:
        __RANDVAR__4071167464721890002__ = n * n - 358680;
      ...
      case 3:
        ...
        break;
      case 16:
        __RANDVAR__74439043212919767364__ = 800;
        _1_OBF_FUNC_next = 11UL;
        break;
      case 24:;
        if (tmp % 10 >= 5) {
      ...
      case 7:;
        ...
        break;
      case 35:
        __RANDVAR__36675624077747579388__ = 702 * (__RANDVAR__36675624077747579388__ + __RANDVAR__36675624077747579388__);
...
// variants: irrelevant-code, loop-fission, block-fission
// expanded variants: irrelevant-code, loop-fission, block-fission:default
