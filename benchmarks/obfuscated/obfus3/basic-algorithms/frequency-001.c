...
int main(int argc, char **argv, char **_formal_envp) {
    ...
    {
      {
        ...
        {
          {
            _1_entropy = 6032847151351899321UL;
  ...
  _2_alwaysZero_i$nit_INLINE__2_alwaysZero_i$nit:
    _2_entropy = 1773854903612124268UL;
  ...
  {
    {
      ...
      while (i14 < 2) {
        ...
        p15 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___1;
        p15->data = (int)((unsigned long)i14 * (((_2_entropy + 6UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffff9UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i8 < 2) {
        ...
        p9 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___3;
        p9->data = (int)((unsigned long)i8 * ((_2_entropy & 8UL) * (_2_entropy | 8UL) + (_2_entropy & 0xfffffffffffffff7UL) * (~_2_entropy & 8UL)));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      p29 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___4;
      p29->next = p29;
      p29->prev = p29;
      ...
      while (i30 < 3) {
        ...
        p31 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___5;
        p31->data = (int)((unsigned long)i30 * ((_1_entropy - 0xfffffffffffffffdUL) - 1UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p23 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___6;
      p23->next = p23;
      p23->prev = p23;
      ...
      while (i24 < 2) {
        ...
        p25 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___7;
        p25->data = (int)((unsigned long)i24 * (((_1_entropy - 4UL) - ((_1_entropy | 0xfffffffffffffffbUL) + (_1_entropy | 0xfffffffffffffffbUL))) - 2UL));
    ...
    while (1) {
      ...
      case 16:
        ...
        break;
      case 41:;
        if ((((_1_alwaysZero & ((_1_entropy | 2UL) - (_1_entropy & 2UL))) * (_1_alwaysZero | ((_1_entropy | 2UL) - (_1_entropy & 2UL))) + (_1_alwaysZero & ~((_1_entropy | 2UL) - (_1_entropy & 2UL))) * (~_1_alwaysZero & ((_1_entropy | 2UL) - (_1_entropy & 2UL)))) - 0xfffffffffffffffeUL) - 1UL) {
          { _1_OBF_FUNC_next___0 = 0UL; }
        } else {
      ...
      case 29:
        ...
        break;
      case 21:;
        if (!((_2_alwaysZero & (((_2_entropy & 0xfffffffffffffff7UL) << 1UL) - (_2_entropy ^ 8UL))) * (_2_alwaysZero | (((_2_entropy & 0xfffffffffffffff7UL) << 1UL) - (_2_entropy ^ 8UL))) + (_2_alwaysZero & ~(((_2_entropy & 0xfffffffffffffff7UL) << 1UL) - (_2_entropy ^ 8UL))) * (~_2_alwaysZero & (((_2_entropy & 0xfffffffffffffff7UL) << 1UL) - (_2_entropy ^ 8UL))))) {
...
// expanded variants: block-fission:default, deadcode:call, flatten:switch
