...
unsigned long _1_entropy = 4989270266644451146UL;
  ...
  {
    {
      ...
      while (i15 < 3) {
        ...
        p16->data = i15 * ((_1_entropy ^ 10) + ((_1_entropy & 10) << 1UL));
    ...
    while (1) {
      ...
      case 26UL:;
        if (tmp % 10 >= 5) {
          ...
          {
            if ((((_1_alwaysZero & (((_1_entropy + 6) + 1UL) + ((-_1_entropy - 1UL) | (-6 - 1UL)))) * (_1_alwaysZero | (((_1_entropy + 6) + 1UL) + ((-_1_entropy - 1UL) | (-6 - 1UL)))) + (_1_alwaysZero & ~(((_1_entropy + 6) + 1UL) + ((-_1_entropy - 1UL) | (-6 - 1UL)))) * (~_1_alwaysZero & (((_1_entropy + 6) + 1UL) + ((-_1_entropy - 1UL) | (-6 - 1UL))))) - ~1) - 1UL) {
              _1_OBF_FUNC_next = 0UL;
            } else {
              _1_OBF_FUNC_next = 0UL - 6;
            }
          }
        }
        break;
      ...
      case 14UL:
        n /= 10;
        _1_OBF_FUNC_next = 27UL;
        if ((((_1_alwaysZero & ((_1_entropy - ~7) - 1UL)) * (_1_alwaysZero | ((_1_entropy - ~7) - 1UL)) + (_1_alwaysZero & ~((_1_entropy - ~7) - 1UL)) * (~_1_alwaysZero & ((_1_entropy - ~7) - 1UL))) | 0) + (((_1_alwaysZero & ((_1_entropy - ~7) - 1UL)) * (_1_alwaysZero | ((_1_entropy - ~7) - 1UL)) + (_1_alwaysZero & ~((_1_entropy - ~7) - 1UL)) * (~_1_alwaysZero & ((_1_entropy - ~7) - 1UL))) & 0)) {
          return (tmp___1);
        } else {
          break;
        }
...
// expanded variants: loop-fission, flatten:switch, deadcode:bug
