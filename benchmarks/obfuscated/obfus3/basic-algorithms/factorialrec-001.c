...
struct _G_fpos_t;
struct timeval;
union __anonunion____missing_field_name_157765915;
...
struct __anonstruct___mbstate_t_911775458;
union __anonunion_pthread_mutex_t_335460617;
union __anonunion_pthread_mutexattr_t_488594144;
struct __pthread_internal_list;
struct __anonstruct_lldiv_t_103911545;
union __anonunion____missing_field_name_669652928;
struct drand48_data;
struct _IO_codecvt;
...
typedef struct __anonstruct___mbstate_t_911775458 __mbstate_t;
...
struct __pthread_cond_s {
  union __anonunion____missing_field_name_669652928 __annonCompField1;
  union __anonunion____missing_field_name_157765915 __annonCompField2;
...
int OBF_FUNC(int n) {
  ...
  void *_1_OBF_FUNC_jumpTab[22] = {&&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab2, &&_1_OBF_FUNC_lab3, &&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab5, &&_1_OBF_FUNC_lab6, &&_1_OBF_FUNC_lab7, &&_1_OBF_FUNC_lab8, &&_1_OBF_FUNC_lab9, &&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab11, &&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab13, &&_1_OBF_FUNC_lab14, &&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab16, &&_1_OBF_FUNC_lab17, &&_1_OBF_FUNC_lab18, &&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab20, &&_1_OBF_FUNC_lab21, &&_1_OBF_FUNC_lab22};
  {
    {
      _3_OBF_FUNC__BEGIN_3 = 1;
      tmp___0 = malloc(sizeof(struct _3_OBF_FUNC_2_opaque_NodeStruct));
      p10 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___0;
      p10->next = p10;
      p10->prev = p10;
      _3_OBF_FUNC_2_opaque_list_1 = p10;
      i11 = 0;
      while (i11 < 2) {
        tmp___1 = malloc(sizeof(struct _3_OBF_FUNC_2_opaque_NodeStruct));
        p12 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___1;
        p12->data = (int)((unsigned long)i11 * ((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p4 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___2;
      p4->next = p4;
      p4->prev = p4;
      _3_OBF_FUNC_1_opaque_list_1 = p4;
      i5 = 0;
      while (i5 < 2) {
        tmp___3 = malloc(sizeof(struct _3_OBF_FUNC_1_opaque_NodeStruct));
        p6 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___3;
        p6->data = (int)((unsigned long)i5 * ((_2_entropy & 0xfffffffffffffffcUL) + 3UL));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      tmp___4 = malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
      p26 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___4;
      p26->next = p26;
      p26->prev = p26;
      _2_OBF_FUNC_2_opaque_list_1 = p26;
      i27 = 0;
      while (i27 < 2) {
        tmp___5 = malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p28 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___5;
        p28->data = (int)((unsigned long)i27 * (((_1_entropy - 1UL) - ((_1_entropy | 0xfffffffffffffffeUL) << 1UL)) - 2UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      tmp___6 = malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
      p20 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___6;
      p20->next = p20;
      p20->prev = p20;
      _2_OBF_FUNC_1_opaque_list_1 = p20;
      i21 = 0;
      while (i21 < 2) {
        tmp___7 = malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p22 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___7;
        p22->data = (int)((unsigned long)i21 * ((_1_entropy + 0xfffffffffffffffaUL) + 1UL));
  ...
  _1_OBF_FUNC_lab2:;
    if ((((_1_alwaysZero & ((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) * (_1_alwaysZero | ((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) + (_1_alwaysZero & ~((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) * (~_1_alwaysZero & ((_1_entropy & 0xfffffffffffffff6UL) + 9UL))) ^ 1UL) + ((((_1_alwaysZero & ((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) * (_1_alwaysZero | ((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) + (_1_alwaysZero & ~((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) * (~_1_alwaysZero & ((_1_entropy & 0xfffffffffffffff6UL) + 9UL))) & 1UL) + (((_1_alwaysZero & ((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) * (_1_alwaysZero | ((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) + (_1_alwaysZero & ~((_1_entropy & 0xfffffffffffffff6UL) + 9UL)) * (~_1_alwaysZero & ((_1_entropy & 0xfffffffffffffff6UL) + 9UL))) & 1UL))) {
  ...
  _1_OBF_FUNC_lab1:;
    if ((((_1_alwaysZero & ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) * (_1_alwaysZero | ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) + (_1_alwaysZero & ~((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) * (~_1_alwaysZero & ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL)))) + ((_1_alwaysZero & ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) * (_1_alwaysZero | ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) + (_1_alwaysZero & ~((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) * (~_1_alwaysZero & ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))))) - ((_1_alwaysZero & ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) * (_1_alwaysZero | ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) + (_1_alwaysZero & ~((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))) * (~_1_alwaysZero & ((_1_entropy & 5UL) * (_1_entropy | 5UL) + (_1_entropy & 0xfffffffffffffffaUL) * (~_1_entropy & 5UL))))) {
      goto _1_OBF_FUNC_lab9;
    } else {
  ...
  _1_OBF_FUNC_lab8:;
    if ((((_2_alwaysZero & ((_2_entropy | 9UL) - (_2_entropy & 9UL))) * (_2_alwaysZero | ((_2_entropy | 9UL) - (_2_entropy & 9UL))) + (_2_alwaysZero & ~((_2_entropy | 9UL) - (_2_entropy & 9UL))) * (~_2_alwaysZero & ((_2_entropy | 9UL) - (_2_entropy & 9UL)))) ^ 1UL) + ((((_2_alwaysZero & ((_2_entropy | 9UL) - (_2_entropy & 9UL))) * (_2_alwaysZero | ((_2_entropy | 9UL) - (_2_entropy & 9UL))) + (_2_alwaysZero & ~((_2_entropy | 9UL) - (_2_entropy & 9UL))) * (~_2_alwaysZero & ((_2_entropy | 9UL) - (_2_entropy & 9UL)))) & 1UL) << 1UL)) {
...
int main(int argc, char **argv, char **_formal_envp) {
    ...
    {
      {
        ...
        {
          {
            _1_entropy = 1038550842016544624UL;
  ...
  _2_alwaysZero_i$nit_INLINE__2_alwaysZero_i$nit:
    _2_entropy = 4471962519317011902UL;
...
// expanded variants: block-fission:default, deadcode:True, flatten:goto
