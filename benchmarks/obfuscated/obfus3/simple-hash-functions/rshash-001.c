    ...
    {
      {
        ...
        {
          {
            _2_entropy = 5852413960711080431UL;
  ...
  {
    {
      ...
      p13 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp;
      p13->next = p13;
      p13->prev = p13;
      ...
      while (i14 < 4) {
        ...
        p15 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___0;
        p15->data = (int)((unsigned long)i14 * ((_1_entropy | 3UL) - (_1_entropy & 3UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p7 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___1;
      p7->next = p7;
      p7->prev = p7;
      ...
      while (i8 < 2) {
        ...
        p9 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___2;
        p9->data = (int)((unsigned long)i8 * ((_1_entropy | 7UL) - (_1_entropy & 7UL)));
    ...
    _2_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      p30 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___3;
      p30->next = p30;
      p30->prev = p30;
      _3_OBF_FUNC_2_opaque_list_1 = p30;
      i31 = 0;
      while (i31 < 4) {
        tmp___4 = malloc(sizeof(struct _3_OBF_FUNC_2_opaque_NodeStruct));
        p32 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___4;
        p32->data = (int)((unsigned long)i31 * (((_2_entropy & 0xfffffffffffffff9UL) << 1UL) - (_2_entropy ^ 6UL)));
        p32->next = _3_OBF_FUNC_2_opaque_list_1->next;
        p32->prev = _3_OBF_FUNC_2_opaque_list_1;
        (_3_OBF_FUNC_2_opaque_list_1->next)->prev = p32;
        _3_OBF_FUNC_2_opaque_list_1->next = p32;
        i31++;
      }
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p24 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___5;
      p24->next = p24;
      p24->prev = p24;
      _3_OBF_FUNC_1_opaque_list_1 = p24;
      i25 = 0;
      while (i25 < 3) {
        tmp___6 = malloc(sizeof(struct _3_OBF_FUNC_1_opaque_NodeStruct));
        p26 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___6;
        p26->data = (int)((unsigned long)i25 * (((_2_entropy + 3UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffcUL)));
        p26->next = _3_OBF_FUNC_1_opaque_list_1->next;
        p26->prev = _3_OBF_FUNC_1_opaque_list_1;
        (_3_OBF_FUNC_1_opaque_list_1->next)->prev = p26;
        _3_OBF_FUNC_1_opaque_list_1->next = p26;
        i25++;
      }
    ...
    while (1) {
      ...
      case 17:
        ...
        break;
      case 10:;
        if ((((_2_alwaysZero & ((_2_entropy & 0xfffffffffffffffaUL) + 5UL)) * (_2_alwaysZero | ((_2_entropy & 0xfffffffffffffffaUL) + 5UL)) + (_2_alwaysZero & ~((_2_entropy & 0xfffffffffffffffaUL) + 5UL)) * (~_2_alwaysZero & ((_2_entropy & 0xfffffffffffffffaUL) + 5UL))) ^ 1UL) + ((((_2_alwaysZero & ((_2_entropy & 0xfffffffffffffffaUL) + 5UL)) * (_2_alwaysZero | ((_2_entropy & 0xfffffffffffffffaUL) + 5UL)) + (_2_alwaysZero & ~((_2_entropy & 0xfffffffffffffffaUL) + 5UL)) * (~_2_alwaysZero & ((_2_entropy & 0xfffffffffffffffaUL) + 5UL))) & 1UL) << 1UL)) {
          { _1_OBF_FUNC_next___0 = 28UL; }
        } else {
          { _1_OBF_FUNC_next___0 = 23UL; }
        }
