...
unsigned long _2_entropy = 4114694434686759609UL;
struct _2_OBF_FUNC_1_opaque_NodeStruct {
  int data;
  ...
  {
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = (int)((unsigned long)i13 * (((_1_entropy & 0xfffffffffffffffdUL) + (_1_entropy & 0xfffffffffffffffdUL)) - (_1_entropy ^ 2UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i24 < 2) {
        ...
        p25->data = i24 * ((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9));
