...
unsigned long _2_entropy = 4520749431301532481UL;
...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  unsigned int hash;
  unsigned int i;
  int __RANDVAR__172112129511492680__;
  ...
  int _3_OBF_FUNC__BARRIER_4;
  {
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i8 < 2) {
        ...
        p9->data = i8 * ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1));
    ...
    if (_3_OBF_FUNC_2_opaque_ptr_1 != _3_OBF_FUNC_2_opaque_ptr_2) {
      ...
      while (1) {
        ...
        case 12:
          ...
          break;
        case 8:
          __RANDVAR__172112129511492680__ = 0;
        ...
        case 21:;
          ...
          break;
        case 26:
          __RANDVAR__172112129511492680__ = 1;
          _1_OBF_FUNC_next = 20UL;
          break;
        case 11:
          str++;
        ...
        case 2:
          ...
          break;
        case 20:;
          if (__RANDVAR__172112129511492680__ == 0) {
