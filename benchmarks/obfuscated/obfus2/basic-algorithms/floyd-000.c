...
unsigned long _2_entropy = 1461340806111695383UL;
  ...
  {
    {
      ...
      while (i28 < 2) {
        ...
        p29->data = i28 * ((_2_entropy & ~1) - (~_2_entropy & 1));
    ...
    while (1) {
      ...
      case 32:;
        ...
        } else if ((((_2_alwaysZero & ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10))) * (_2_alwaysZero | ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10))) + (_2_alwaysZero & ~((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10))) * (~_2_alwaysZero & ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10)))) ^ 1) + ((((_2_alwaysZero & ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10))) * (_2_alwaysZero | ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10))) + (_2_alwaysZero & ~((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10))) * (~_2_alwaysZero & ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10)))) & 1) << 1UL)) {
          _1_OBF_FUNC_next = 133UL;
        } else {
        }
        break;
