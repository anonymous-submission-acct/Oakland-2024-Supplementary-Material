...
int OBF_FUNC(int num1, int num2) {
  int max;
  int __RANDVAR__52312145858188867201__;
  ...
  {
    {
      ...
      while (i12 < 2) {
        ...
        p13->data = i12 * (((_1_entropy | 10) + (_1_entropy | 10)) - (_1_entropy ^ 10));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i6 < 2) {
        ...
        p7->data = i6 * ((_1_entropy & 9) * (_1_entropy | 9) + (_1_entropy & ~9) * (~_1_entropy & 9));
    ...
    while (1) {
      ...
      __RANDVAR__52312145858188867201__ = 204;
      max++;
    }
  }
}
