...
unsigned long _1_entropy = 4986494503227877389UL;
...
int OBF_FUNC(int num1, int num2) {
  int max;
  int __RANDVAR__82171812698446158689__;
  ...
  {
    {
      ...
      while (i12 < 3) {
        ...
        p13->data = i12 * (((_1_entropy & ~8) + (_1_entropy & ~8)) - (_1_entropy ^ 8));
    ...
    __RANDVAR__82171812698446158689__ = 0;
    while (__RANDVAR__82171812698446158689__ == 0) {
      if (max % num1 == 0) {
        if (max % num2 == 0) {
      ...
      __RANDVAR__82171812698446158689__ = 1;
    }
    return (0);
  }
}
