...
unsigned long _1_entropy = 9150159583757899093UL;
...
void OBF_FUNC(int *x, int first, int last) {
  int pivot;
  int __RANDVAR__82632768724470390248__;
  int __RANDVAR__57704639354535083806__;
  int __RANDVAR__43433018252836656445__;
  int j;
  int __RANDVAR__58143024851046615874__;
  int temp;
  int i;
  int __RANDVAR__63102262966465196236__;
  int __RANDVAR__7251166034081958873__;
  int __RANDVAR__94083534269460251770__;
  int __RANDVAR__27100272554221693783__;
  int __RANDVAR__9276927899096323579__;
  int __RANDVAR__37337678900205871629__;
  ...
  {
    {
      ...
      while (i25 < 3) {
        ...
        p26->data = i25 * (((_1_entropy + 4) + 1UL) + ((-_1_entropy - 1UL) | (-4 - 1UL)));
    ...
    if (((((_1_alwaysZero & ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) * (_1_alwaysZero | ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) + (_1_alwaysZero & ~((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) * (~_1_alwaysZero & ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5)))) | 1) + (((_1_alwaysZero & ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) * (_1_alwaysZero | ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) + (_1_alwaysZero & ~((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) * (~_1_alwaysZero & ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5)))) | 1)) - (((_1_alwaysZero & ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) * (_1_alwaysZero | ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) + (_1_alwaysZero & ~((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5))) * (~_1_alwaysZero & ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5)))) ^ 1)) {
      if (first - 839 < last) {
        if (first < 690 - (639 + last)) {
          first -= 135;
          first += 135;
        } else {
          __RANDVAR__82632768724470390248__ = 1358 - first;
          if (__RANDVAR__82632768724470390248__ < 670) {
            if (__RANDVAR__82632768724470390248__ < first) {
              last += 698;
              last -= 698;
            } else if (first < 160) {
              last += 714;
              ...
              __RANDVAR__57704639354535083806__ = 463;
            }
          } else {
            __RANDVAR__43433018252836656445__ = first;
          }
        }
      } else {
        first += 465;
    ...
    __RANDVAR__58143024851046615874__ = first * 145 + last * 356;
    if (first < 805) {
      __RANDVAR__58143024851046615874__ -= 785;
      __RANDVAR__58143024851046615874__ += 785;
    } else {
      __RANDVAR__58143024851046615874__ += 21;
      __RANDVAR__58143024851046615874__ -= 21;
    }
    first += 90;
    first -= 90;
    if (first < last) {
      ...
      while (i < j) {
        ...
        __RANDVAR__58143024851046615874__ -= 472;
        __RANDVAR__58143024851046615874__ += 472;
        if (i < j) {
          temp = *(x + i);
          last += 374;
          last -= 374;
          *(x + i) = *(x + j);
          __RANDVAR__63102262966465196236__ = 511;
          *(x + j) = temp;
        }
      }
      __RANDVAR__7251166034081958873__ = __RANDVAR__58143024851046615874__;
      if (first < last) {
        last += 650;
        last -= 650;
      } else {
        __RANDVAR__94083534269460251770__ = 937;
        if (633 + last < 652 - 967 * first) {
          __RANDVAR__27100272554221693783__ = 428;
        } else {
          __RANDVAR__9276927899096323579__ = __RANDVAR__58143024851046615874__;
        }
      }
      temp = *(x + pivot);
      *(x + pivot) = *(x + j);
      __RANDVAR__37337678900205871629__ = 679;
      *(x + j) = temp;
