...
unsigned long _2_entropy = 6422236351981467365UL;
struct _2_OBF_FUNC_1_opaque_NodeStruct {
  int data;
  ...
  {
    {
      ...
      while (i14 < 2) {
        ...
        p15 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___1;
        p15->data = (int)((unsigned long)i14 * ((_1_entropy ^ 3UL) - ((~_1_entropy & 3UL) + (~_1_entropy & 3UL))));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i8 < 3) {
        ...
        p9 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___3;
        p9->data = (int)((unsigned long)i8 * (((_1_entropy - 9UL) - ((_1_entropy | 0xfffffffffffffff6UL) << 1UL)) - 2UL));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i25 < 2) {
        ...
        p26->data = i25 * (((_2_entropy ^ ~1) + ((_2_entropy | 1) << 1UL)) + 1UL);
