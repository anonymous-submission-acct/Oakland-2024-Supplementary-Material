...
unsigned long _2_entropy = 5865813594962847411UL;
struct _2_OBF_FUNC_1_opaque_NodeStruct {
  int data;
  ...
  {
    {
      ...
      p10 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp;
      p10->next = p10;
      p10->prev = p10;
      ...
      while (i11 < 4) {
        ...
        p12 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___0;
        p12->data = (int)((unsigned long)i11 * ((_1_entropy & 0xfffffffffffffffcUL) + 3UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p4 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___1;
      p4->next = p4;
      p4->prev = p4;
      ...
      while (i5 < 2) {
        ...
        p6 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___2;
        p6->data = (int)((unsigned long)i5 * ((_1_entropy & 0xfffffffffffffff6UL) - (~_1_entropy & 9UL)));
    ...
    _2_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      p27->next = p27;
      p27->prev = p27;
      _3_OBF_FUNC_2_opaque_list_1 = p27;
      i28 = 0;
      while (i28 < 4) {
        p29 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _3_OBF_FUNC_2_opaque_NodeStruct));
        p29->data = i28 * ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10));
        p29->next = _3_OBF_FUNC_2_opaque_list_1->next;
        p29->prev = _3_OBF_FUNC_2_opaque_list_1;
        (_3_OBF_FUNC_2_opaque_list_1->next)->prev = p29;
        _3_OBF_FUNC_2_opaque_list_1->next = p29;
        i28++;
      }
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p21->next = p21;
      p21->prev = p21;
      _3_OBF_FUNC_1_opaque_list_1 = p21;
      i22 = 0;
      while (i22 < 4) {
        p23 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _3_OBF_FUNC_1_opaque_NodeStruct));
        p23->data = i22 * ((_2_entropy & ~7) + 7);
        p23->next = _3_OBF_FUNC_1_opaque_list_1->next;
        p23->prev = _3_OBF_FUNC_1_opaque_list_1;
        (_3_OBF_FUNC_1_opaque_list_1->next)->prev = p23;
        _3_OBF_FUNC_1_opaque_list_1->next = p23;
        i22++;
      }
    ...
    while (1) {
      ...
      case 6:;
        {
          if (((((_2_alwaysZero & ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6))) * (_2_alwaysZero | ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6))) + (_2_alwaysZero & ~((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6))) * (~_2_alwaysZero & ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6)))) | 1) << 1UL) - (((_2_alwaysZero & ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6))) * (_2_alwaysZero | ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6))) + (_2_alwaysZero & ~((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6))) * (~_2_alwaysZero & ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6)))) ^ 1)) {
            if (((((_2_alwaysZero & ((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9))) * (_2_alwaysZero | ((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9))) + (_2_alwaysZero & ~((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9))) * (~_2_alwaysZero & ((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9)))) | 0) << 1UL) - (((_2_alwaysZero & ((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9))) * (_2_alwaysZero | ((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9))) + (_2_alwaysZero & ~((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9))) * (~_2_alwaysZero & ((_2_entropy & 9) * (_2_entropy | 9) + (_2_entropy & ~9) * (~_2_entropy & 9)))) ^ 0)) {
            } else if ((((_1_alwaysZero & ((_1_entropy & 6UL) * (_1_entropy | 6UL) + (_1_entropy & 0xfffffffffffffff9UL) * (~_1_entropy & 6UL))) * (_1_alwaysZero | ((_1_entropy & 6UL) * (_1_entropy | 6UL) + (_1_entropy & 0xfffffffffffffff9UL) * (~_1_entropy & 6UL))) + (_1_alwaysZero & ~((_1_entropy & 6UL) * (_1_entropy | 6UL) + (_1_entropy & 0xfffffffffffffff9UL) * (~_1_entropy & 6UL))) * (~_1_alwaysZero & ((_1_entropy & 6UL) * (_1_entropy | 6UL) + (_1_entropy & 0xfffffffffffffff9UL) * (~_1_entropy & 6UL)))) - 0xffffffffffffffffUL) - 1UL) {
    ...
    {
      {
        ...
        {
          {
            _1_entropy = 3404884131871669180UL;
...
// expanded variants: deadcode:call, block-fission:default
