...
unsigned long _2_entropy = 4588802643454336436UL;
struct _2_OBF_FUNC_1_opaque_NodeStruct {
  ...
  {
    {
      ...
      p9 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___0;
      p9->next = p9;
      p9->prev = p9;
      _2_OBF_FUNC_2_opaque_list_1 = p9;
      i10 = 0;
      while (i10 < 2) {
        tmp___1 = malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p11 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___1;
        p11->data = (int)((unsigned long)i10 * ((_1_entropy & 10UL) * (_1_entropy | 10UL) + (_1_entropy & 0xfffffffffffffff5UL) * (~_1_entropy & 10UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p3 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___2;
      p3->next = p3;
      p3->prev = p3;
      _2_OBF_FUNC_1_opaque_list_1 = p3;
      i4 = 0;
      while (i4 < 3) {
        tmp___3 = malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p5 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___3;
        p5->data = (int)((unsigned long)i4 * (((_1_entropy - 4UL) - ((_1_entropy | 0xfffffffffffffffbUL) << 1UL)) - 2UL));
    ...
    _2_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i27 < 2) {
        ...
        p28->data = i27 * (((_2_entropy + 5) + 1UL) + ((-_2_entropy - 1UL) | (-5 - 1UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i21 < 3) {
        ...
        p22->data = i21 * ((_2_entropy ^ 7) - ((~_2_entropy & 7) << 1UL));
    ...
    while (1) {
      ...
      case 7:;
        ...
        if ((((_2_alwaysZero & ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) * (_2_alwaysZero | ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) + (_2_alwaysZero & ~((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) * (~_2_alwaysZero & ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7)))) ^ 0) + ((((_2_alwaysZero & ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) * (_2_alwaysZero | ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) + (_2_alwaysZero & ~((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) * (~_2_alwaysZero & ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7)))) & 0) + (((_2_alwaysZero & ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) * (_2_alwaysZero | ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) + (_2_alwaysZero & ~((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7))) * (~_2_alwaysZero & ((_2_entropy & 7) * (_2_entropy | 7) + (_2_entropy & ~7) * (~_2_entropy & 7)))) & 0))) {
        } else {
          break;
        }
      case 2:;
