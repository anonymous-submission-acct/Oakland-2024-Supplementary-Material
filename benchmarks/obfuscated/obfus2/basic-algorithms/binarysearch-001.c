...
unsigned long _1_entropy = 4485299894930004914UL;
...
_Bool OBF_FUNC(int *a, int n, int m) {
  ...
  int u;
  int mid;
  int __RANDVAR__72899578433814791380__;
  int __RANDVAR__15390310338143085836__;
  int __RANDVAR__26350469096419315063__;
  int __RANDVAR__92606800309252473898__;
  int __RANDVAR__45700030461168639823__;
  int __RANDVAR__13555537093112962813__;
  int __RANDVAR__34614990238888059174__;
  int __RANDVAR__39956263774512878284__;
  ...
  _Bool randomVars_BogusReturn27;
  {
    {
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i16 < 2) {
        ...
        p17->data = i16 * ((_1_entropy ^ 8) + ((_1_entropy & 8) << 1UL));
    ...
    __RANDVAR__72899578433814791380__++;
    if (700 * (__RANDVAR__72899578433814791380__ + __RANDVAR__72899578433814791380__) < (m + n) - 259257) {
      if (_2_OBF_FUNC_1_opaque_ptr_1 == _2_OBF_FUNC_1_opaque_ptr_2) {
      } else {
        randomVars_BogusReturn27 = OBF_FUNC(a, __RANDVAR__92606800309252473898__, __RANDVAR__13555537093112962813__);
      }
      __RANDVAR__15390310338143085836__ = 345;
      if (m < __RANDVAR__15390310338143085836__ + n) {
        __RANDVAR__92606800309252473898__ = __RANDVAR__15390310338143085836__ * n - 950;
      } else {
        __RANDVAR__45700030461168639823__ = 837;
      }
    } else {
      __RANDVAR__13555537093112962813__ = 764;
    }
    l = 0;
    m += 380;
    m -= 380;
    ...
    while (1) {
      {
        if ((((_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (_1_alwaysZero | ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) + (_1_alwaysZero & ~((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (~_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10)))) - ~0) - 1UL) {
          i22 = main(__RANDVAR__45700030461168639823__, 0, 0);
        } else {
        }
        if (!(l <= u)) {
          break;
      ...
      __RANDVAR__34614990238888059174__ = n;
      mid = (l + u) / 2;
      if (m == *(a + mid)) {
        __RANDVAR__39956263774512878284__ = 275;
        if (__RANDVAR__39956263774512878284__ < 765) {
          n -= 281;
          n += 281;
        } else {
          m -= 601;
