...
struct _G_fpos_t;
union __anonunion____missing_field_name_348086345;
...
struct __anonstruct___mbstate_t_461654016;
struct _IO_marker;
union __anonunion____missing_field_name_370885435;
struct timeval;
...
typedef struct __anonstruct___mbstate_t_461654016 __mbstate_t;
...
extern FILE *stderr;
struct __pthread_cond_s {
  union __anonunion____missing_field_name_370885435 __annonCompField1;
  union __anonunion____missing_field_name_348086345 __annonCompField2;
...
unsigned long _1_entropy = 2749381042309198634UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i11 < 4) {
        ...
        p12->data = (int)((unsigned long)i11 * (((_2_entropy | 3UL) + (_2_entropy | 3UL)) - (_2_entropy ^ 3UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i5 < 4) {
        ...
        p6->data = (int)((unsigned long)i5 * (((_2_entropy ^ 0xfffffffffffffffcUL) + ((_2_entropy | 3UL) << 1UL)) + 1UL));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i27 < 2) {
        ...
        p28->data = i27 * ((_1_entropy | 3) - (_1_entropy & 3));
    ...
    while (1) {
      if (!((((_2_alwaysZero & (((_2_entropy | 7UL) + (_2_entropy | 7UL)) - (_2_entropy ^ 7UL))) * (_2_alwaysZero | (((_2_entropy | 7UL) + (_2_entropy | 7UL)) - (_2_entropy ^ 7UL))) + (_2_alwaysZero & ~(((_2_entropy | 7UL) + (_2_entropy | 7UL)) - (_2_entropy ^ 7UL))) * (~_2_alwaysZero & (((_2_entropy | 7UL) + (_2_entropy | 7UL)) - (_2_entropy ^ 7UL)))) - 0xffffffffffffffffUL) - 1UL)) {
        ...
        case 6UL:;
          ...
          } else if ((((_1_alwaysZero & (((_1_entropy - 2) - ((_1_entropy | ~2) + (_1_entropy | ~2))) - 2UL)) * (_1_alwaysZero | (((_1_entropy - 2) - ((_1_entropy | ~2) + (_1_entropy | ~2))) - 2UL)) + (_1_alwaysZero & ~(((_1_entropy - 2) - ((_1_entropy | ~2) + (_1_entropy | ~2))) - 2UL)) * (~_1_alwaysZero & (((_1_entropy - 2) - ((_1_entropy | ~2) + (_1_entropy | ~2))) - 2UL))) - ~1) - 1UL) {
            _1_OBF_FUNC_next = 2UL;
          } else {
          }
          break;
        ...
        case 0UL:;
          if ((int)*(str + i) != 0) {
            ...
            {
              if ((((_1_alwaysZero & ((_1_entropy | 10) + (_1_entropy & 10))) * (_1_alwaysZero | ((_1_entropy | 10) + (_1_entropy & 10))) + (_1_alwaysZero & ~((_1_entropy | 10) + (_1_entropy & 10))) * (~_1_alwaysZero & ((_1_entropy | 10) + (_1_entropy & 10)))) ^ 0) + ((((_1_alwaysZero & ((_1_entropy | 10) + (_1_entropy & 10))) * (_1_alwaysZero | ((_1_entropy | 10) + (_1_entropy & 10))) + (_1_alwaysZero & ~((_1_entropy | 10) + (_1_entropy & 10))) * (~_1_alwaysZero & ((_1_entropy | 10) + (_1_entropy & 10)))) & 0) << 1UL)) {
              } else {
    ...
    {
      {
        ...
        {
          {
            _2_entropy = 5396261744716196419UL;
