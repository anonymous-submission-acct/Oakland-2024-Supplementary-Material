...
unsigned long _2_entropy = 9158261265859612463UL;
  ...
  {
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * ((_2_entropy ^ 10) - ((~_2_entropy & 10) << 1UL));
    ...
    while (1) {
      ...
      case 6:
        ...
        _1_OBF_FUNC_next = 5UL;
        {
          if ((((_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1)))) | 0) + (((_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1)))) & 0)) {
          } else {
            break;
          }
        }
