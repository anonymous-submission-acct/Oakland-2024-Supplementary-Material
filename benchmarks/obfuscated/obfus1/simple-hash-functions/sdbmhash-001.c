...
unsigned long _2_entropy = 2118973684013433687UL;
  ...
  {
    {
      ...
      while (i13 < 4) {
        ...
        p14->data = i13 * ((_2_entropy ^ 4) + ((_2_entropy & 4) + (_2_entropy & 4)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8->data = i7 * ((_2_entropy & 3) * (_2_entropy | 3) + (_2_entropy & ~3) * (~_2_entropy & 3));
