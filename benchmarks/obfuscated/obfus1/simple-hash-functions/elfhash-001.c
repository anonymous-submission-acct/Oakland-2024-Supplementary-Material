...
struct __anonstruct___mbstate_t_47030366;
...
typedef struct __anonstruct___mbstate_t_47030366 __mbstate_t;
  ...
  int _2_OBF_FUNC__BARRIER_4;
  {
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 4) {
        ...
        p8->data = i7 * ((_1_entropy & 7) * (_1_entropy | 7) + (_1_entropy & ~7) * (~_1_entropy & 7));
