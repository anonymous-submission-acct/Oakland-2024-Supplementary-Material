...
void OBF_FUNC_FLATTEN_SPLIT_4(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab3:
    _1_OBF_FUNC_arg->hash = 1315423911U;
...
void OBF_FUNC_FLATTEN_SPLIT_2(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab2:
    _1_OBF_FUNC_arg->hash ^= ((_1_OBF_FUNC_arg->hash << 5) + (unsigned int)*(*(_1_OBF_FUNC_arg->str))) + (_1_OBF_FUNC_arg->hash >> 2);
...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  ...
  void (*_1_OBF_FUNC_jumpTab[7])(struct _1_OBF_FUNC_argStruct * _1_OBF_FUNC_arg) = {&OBF_FUNC_FLATTEN_SPLIT_3, &OBF_FUNC_FLATTEN_SPLIT_0, &OBF_FUNC_FLATTEN_SPLIT_2, &OBF_FUNC_FLATTEN_SPLIT_4, &OBF_FUNC_FLATTEN_SPLIT_6, &OBF_FUNC_FLATTEN_SPLIT_1, &OBF_FUNC_FLATTEN_SPLIT_5};
  {
