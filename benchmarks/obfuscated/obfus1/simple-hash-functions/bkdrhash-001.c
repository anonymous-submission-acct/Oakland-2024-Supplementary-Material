...
unsigned long _1_entropy = 8393033680963489730UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i13 < 3) {
        ...
        p14->data = i13 * ((_1_entropy ^ 7) - ((~_1_entropy & 7) << 1UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8->data = i7 * ((_1_entropy & 8) * (_1_entropy | 8) + (_1_entropy & ~8) * (~_1_entropy & 8));
    ...
    while (1) {
      if (_2_OBF_FUNC_2_opaque_ptr_1 == _2_OBF_FUNC_2_opaque_ptr_2) {
        ...
        {
          if ((((_1_alwaysZero & (((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL)) * (_1_alwaysZero | (((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL)) + (_1_alwaysZero & ~(((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL)) * (~_1_alwaysZero & (((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL))) ^ 0) + ((((_1_alwaysZero & (((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL)) * (_1_alwaysZero | (((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL)) + (_1_alwaysZero & ~(((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL)) * (~_1_alwaysZero & (((_1_entropy ^ ~8) + ((_1_entropy | 8) << 1UL)) + 1UL))) & 0) << 1UL)) {
            return (3U);
          } else {
            return (len);
          }
