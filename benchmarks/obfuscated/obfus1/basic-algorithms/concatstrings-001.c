...
unsigned long _2_entropy = 2403722993493329543UL;
  ...
  {
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 3) {
        ...
        p8->data = i7 * (((_2_entropy - 5) - ((_2_entropy | ~5) + (_2_entropy | ~5))) - 2UL);
