...
unsigned long _1_entropy = 407791329855683977UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i13 < 4) {
        ...
        p14->data = i13 * (((_1_entropy - 7) - ((_1_entropy | ~7) << 1UL)) - 2UL);
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8->data = i7 * ((_1_entropy & 3) * (_1_entropy | 3) + (_1_entropy & ~3) * (~_1_entropy & 3));
