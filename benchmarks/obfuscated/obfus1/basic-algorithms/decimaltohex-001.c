...
unsigned long _2_entropy = 7284064802335919101UL;
  ...
  int _3_OBF_FUNC__BARRIER_4;
  {
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i11 < 2) {
        ...
        p12->data = i11 * (((_2_entropy ^ ~1) + ((_2_entropy | 1) + (_2_entropy | 1))) + 1UL);
    ...
    while (1) {
      ...
      case 13:
        ...
        if ((((_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1)))) ^ 1) + ((((_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1)))) & 1) + (((_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1)))) & 1))) {
          break;
        } else {
        }
      case 19:
...
// variants: block-fission
// expanded variants: block-fission:default
