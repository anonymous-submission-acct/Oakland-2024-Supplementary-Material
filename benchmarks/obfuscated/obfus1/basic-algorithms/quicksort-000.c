...
unsigned long _1_entropy = 1668468192615490057UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i15 < 2) {
        ...
        p16->data = i15 * (((_1_entropy - 8) - ((_1_entropy | ~8) + (_1_entropy | ~8))) - 2UL);
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i9 < 2) {
        ...
        p10->data = i9 * ((_1_entropy ^ 4) + ((_1_entropy & 4) + (_1_entropy & 4)));
