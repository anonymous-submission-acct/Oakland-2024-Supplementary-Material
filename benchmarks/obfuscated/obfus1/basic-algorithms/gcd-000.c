...
union __anonunion____missing_field_name_327691945;
...
union __anonunion____missing_field_name_393057147;
...
char **_global_argv;
struct __pthread_cond_s {
  union __anonunion____missing_field_name_327691945 __annonCompField1;
  union __anonunion____missing_field_name_393057147 __annonCompField2;
...
unsigned long _2_entropy = 7673761787022684973UL;
  ...
  {
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * ((_2_entropy | 3) - (_2_entropy & 3));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8->data = i7 * ((_2_entropy & 6) * (_2_entropy | 6) + (_2_entropy & ~6) * (~_2_entropy & 6));
    ...
    while (1) {
      ...
      case 1:
        ...
        if (_3_OBF_FUNC_2_opaque_ptr_1 == _3_OBF_FUNC_2_opaque_ptr_2) {
          ...
          {
            if (((((_2_alwaysZero & ((_2_entropy | 1) + (_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy | 1) + (_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy | 1) + (_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy | 1) + (_2_entropy & 1)))) ^ ~0) + ((((_2_alwaysZero & ((_2_entropy | 1) + (_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy | 1) + (_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy | 1) + (_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy | 1) + (_2_entropy & 1)))) | 0) + (((_2_alwaysZero & ((_2_entropy | 1) + (_2_entropy & 1))) * (_2_alwaysZero | ((_2_entropy | 1) + (_2_entropy & 1))) + (_2_alwaysZero & ~((_2_entropy | 1) + (_2_entropy & 1))) * (~_2_alwaysZero & ((_2_entropy | 1) + (_2_entropy & 1)))) | 0))) + 1UL) {
            } else {
