...
unsigned int OBF_FUNC(unsigned int input) {
  ...
  if ((localStaticState[0UL] >> 1U) & 1) {
    if ((localStaticState[0UL] >> 3U) & 1) {
      ...
      case 1UL:
        ...
        _induction1_0_2 = 0UL;
        _index0_1 = 0UL;
        int __RANDVAR__66342976818043491036__ = 0;
        while (__RANDVAR__66342976818043491036__ == 0) {
          if (_index0_1 < 1UL) {
          ...
          __RANDVAR__66342976818043491036__ = 1;
        }
        break;
      default:
      ...
      if ((localStaticState[0UL] >> 1U) & 1) {
        ...
        _induction3_2_2 = 0UL;
        _index2_1 = 0UL;
        int __RANDVAR__57540598524467596__ = 0;
        while (__RANDVAR__57540598524467596__ == 0) {
          if (_index2_1 < 1UL) {
          ...
          __RANDVAR__57540598524467596__ = 1;
        }
        _induction5_4_2 = 0UL;
        _index4_3 = 0UL;
        int __RANDVAR__39789944936462348732__ = 0;
        while (__RANDVAR__39789944936462348732__ == 0) {
          if (_index4_3 < 3UL) {
          ...
          __RANDVAR__39789944936462348732__ = 1;
        }
      }
    }
  }
  if ((localStaticState[1UL] >> 3U) & 1) {
    ...
    _induction7_6_2 = 0UL;
    _index6_1 = 0UL;
    int __RANDVAR__62893547065716745012__ = 0;
    while (__RANDVAR__62893547065716745012__ == 0) {
      if (_index6_1 < 1UL) {
      ...
      __RANDVAR__62893547065716745012__ = 1;
    }
  }
