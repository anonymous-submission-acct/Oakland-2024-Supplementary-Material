unsigned int OBF_FUNC(unsigned int input)
{
  ...
  localStaticState[0UL] = (input + 297072123UL) - 467100053U;
    ...
    switch (((int) localStaticState[((int) localStaticState[1UL]) % 2UL]) % 4UL)
    {
        ...
        while (_index2_0 < 0UL)
      {
        ...
        while (_index6_0 < 0UL)
        {
          ...
          while (_index8_0 < 0UL)
          {
            localStaticState[_induction1_0_2 % 2UL] = localStaticState[_index6_0 % 2UL] * localStaticState[_induction9_8_2];
      ...
      {
        localStaticState[_induction1_0_2] = localStaticState[((int) localStaticState[0UL]) % 2UL] - localStaticState[_induction13_12_2 % 2UL];
        _induction13_12_2 = (_induction13_12_2 + 1UL) % 2UL;
        _index12_0 += 2UL;
      }

        localStaticState[0UL] *= localStaticState[_index0_9 % 2UL];
        break;
  ...
  return localStaticState[0UL] + (localStaticState[1UL] * 8260261UL);
}
