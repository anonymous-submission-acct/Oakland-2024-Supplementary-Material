...
unsigned long _2_entropy = 8313078033785685523UL;
struct _2_OBF_FUNC_1_opaque_NodeStruct {
  int data;
    ...
    {
      {
        ...
        {
          {
            _1_entropy = 1883737406324290705UL;
  ...
  {
    {
      ...
      while (i26 < 2) {
        ...
        p27->data = (int)((unsigned long)i26 * (((_1_entropy & 0xfffffffffffffffdUL) + (_1_entropy & 0xfffffffffffffffdUL)) - (_1_entropy ^ 2UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i20 < 2) {
        ...
        p21->data = (int)((unsigned long)i20 * ((_1_entropy | 7UL) - (_1_entropy & 7UL)));
    ...
    _2_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i43 < 2) {
        ...
        p44->data = i43 * ((_2_entropy & 8) * (_2_entropy | 8) + (_2_entropy & ~8) * (~_2_entropy & 8));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i37 < 2) {
        ...
        p38->data = i37 * ((_2_entropy | 10) + (_2_entropy & 10));
    ...
    while (1) {
      ...
      case 7:
        ...
        _1_OBF_FUNC_next = 53UL;
        if ((((_2_alwaysZero & ((_2_entropy & 2) * (_2_entropy | 2) + (_2_entropy & ~2) * (~_2_entropy & 2))) * (_2_alwaysZero | ((_2_entropy & 2) * (_2_entropy | 2) + (_2_entropy & ~2) * (~_2_entropy & 2))) + (_2_alwaysZero & ~((_2_entropy & 2) * (_2_entropy | 2) + (_2_entropy & ~2) * (~_2_entropy & 2))) * (~_2_alwaysZero & ((_2_entropy & 2) * (_2_entropy | 2) + (_2_entropy & ~2) * (~_2_entropy & 2)))) - ~0) - 1UL) {
        } else {
          break;
        }
      case 43:
