    ...
    {
      {
        ...
        {
          {
            _2_entropy = 6894361823667702901UL;
...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  ...
  void *_1_OBF_FUNC_jumpTab[10] = {&&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab3, &&_1_OBF_FUNC_lab4, &&_1_OBF_FUNC_lab5, &&_1_OBF_FUNC_lab6, &&_1_OBF_FUNC_lab7, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab9};
  {
    {
      ...
      while (i11 < 3) {
        ...
        p12->data = (int)((unsigned long)i11 * (((_2_entropy | 8UL) << 1UL) - (_2_entropy ^ 8UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i5 < 4) {
        ...
        p6->data = (int)((unsigned long)i5 * (((_2_entropy & 0xfffffffffffffff5UL) << 1UL) - (_2_entropy ^ 10UL)));
  ...
  _1_OBF_FUNC_lab7:;
    if (!((((_2_alwaysZero & ((_2_entropy | 5UL) - (_2_entropy & 5UL))) * (_2_alwaysZero | ((_2_entropy | 5UL) - (_2_entropy & 5UL))) + (_2_alwaysZero & ~((_2_entropy | 5UL) - (_2_entropy & 5UL))) * (~_2_alwaysZero & ((_2_entropy | 5UL) - (_2_entropy & 5UL)))) - 0xffffffffffffffffUL) - 1UL)) {
...
// variants: block-fission, loop-fission, flatten
// expanded variants: block-fission:default, loop-fission, flatten:goto
