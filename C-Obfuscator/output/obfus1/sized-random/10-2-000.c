...
unsigned long _2_entropy = 9214540510054304305UL;
  ...
  {
    {
      ...
      while (i19 < 2) {
        ...
        p20->data = i19 * (((_2_entropy & ~8) + (_2_entropy & ~8)) - (_2_entropy ^ 8));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * ((_2_entropy & 8) * (_2_entropy | 8) + (_2_entropy & ~8) * (~_2_entropy & 8));
    ...
    while (1) {
      ...
      case 1:
        ...
        break;
      case 23:;
        if (((((_2_alwaysZero & ((_2_entropy & ~6) + 6)) * (_2_alwaysZero | ((_2_entropy & ~6) + 6)) + (_2_alwaysZero & ~((_2_entropy & ~6) + 6)) * (~_2_alwaysZero & ((_2_entropy & ~6) + 6))) | 1) << 1UL) - (((_2_alwaysZero & ((_2_entropy & ~6) + 6)) * (_2_alwaysZero | ((_2_entropy & ~6) + 6)) + (_2_alwaysZero & ~((_2_entropy & ~6) + 6)) * (~_2_alwaysZero & ((_2_entropy & ~6) + 6))) ^ 1)) {
