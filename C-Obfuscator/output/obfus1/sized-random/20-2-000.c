  ...
  {
    {
      ...
      while (i16 < 4) {
        ...
        p17->data = i16 * ((_1_entropy & 4) * (_1_entropy | 4) + (_1_entropy & ~4) * (~_1_entropy & 4));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i10 < 2) {
        ...
        p11->data = i10 * (((_1_entropy + 8) + 1UL) + ((-_1_entropy - 1UL) | (-8 - 1UL)));
        ...
        if ((localStaticState[1UL] >> 1U) & 1U) {
          ...
          while (1) {
            if (!((unsigned long)_index2_2 < 2UL)) {
              {
                if ((((_1_alwaysZero & ((_1_entropy & ~5) + 5)) * (_1_alwaysZero | ((_1_entropy & ~5) + 5)) + (_1_alwaysZero & ~((_1_entropy & ~5) + 5)) * (~_1_alwaysZero & ((_1_entropy & ~5) + 5))) - ~1) - 1UL) {
                  break;
                } else {
