  ...
  {
    {
      ...
      while (i16 < 3) {
        ...
        p17->data = i16 * ((_1_entropy ^ 7) - ((~_1_entropy & 7) << 1UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i10 < 2) {
        ...
        p11->data = i10 * ((_1_entropy & 8) * (_1_entropy | 8) + (_1_entropy & ~8) * (~_1_entropy & 8));
    ...
    }
    {
      if (_2_OBF_FUNC_2_opaque_ptr_1 != _2_OBF_FUNC_2_opaque_ptr_2) {
        _induction3_2_2 = 0U >> 2;
        _index2_0 = 0U / _index0_8;
      } else {
        _induction3_2_2 = 0U;
        _index2_0 = 0U;
      }
    ...
    while ((unsigned long)_index2_0 < 0UL) {
      ...
      if (_2_OBF_FUNC_2_opaque_ptr_1 == _2_OBF_FUNC_2_opaque_ptr_2) {
        ...
        while (1) {
          if (((unsigned long)_index4_0 < 0UL) <= i16) {
            return (_induction3_2_2);
          }
          _induction5_4_2 = 1U;
          _index4_0 = _induction5_4_2;
        }
      }
