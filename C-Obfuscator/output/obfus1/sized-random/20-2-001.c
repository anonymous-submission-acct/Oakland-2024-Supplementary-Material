...
unsigned int OBF_FUNC(unsigned int input)
{
  ...
  localStaticState[0UL] = (input + 319896263UL) - 2520718148;
  localStaticState[1UL] = input - localStaticState[0UL];
  switch (((int)(localStaticState[((int)localStaticState[1UL]) % 2UL] + localStaticState[0UL])) % 4UL) {
  case 0UL:
  ...
  case 1UL:
    if (!((localStaticState[1UL] >> 4U) & 1)) {
      _induction1_0_2 = 0UL;
      _index0_1 = 0UL;
      int __RANDVAR__10187766971743686334__ = 0;
      while (__RANDVAR__10187766971743686334__ == 0) {
        if (_index0_1 < 1UL) {
        ...
        __RANDVAR__10187766971743686334__ = 1;
      }
      if ((localStaticState[1UL] >> 1U) & 1) {
        _induction3_2_2 = 0UL;
        _index2_2 = 0UL;
        int __RANDVAR__55785513782449331045__ = 0;
        while (__RANDVAR__55785513782449331045__ == 0) {
          if (_index2_2 < 2UL) {
          ...
          __RANDVAR__55785513782449331045__ = 1;
        }
      ...
      case 0UL:
        _induction5_4_2 = 0UL;
        _index4_3 = 0UL;
        int __RANDVAR__57546316499699456150__ = 0;
        while (__RANDVAR__57546316499699456150__ == 0) {
          if (_index4_3 < 3UL) {
            localStaticState[0UL] += localStaticState[_induction5_4_2];
            localStaticState[_index4_3 % 2UL] -= localStaticState[_induction5_4_2 % 2UL];
          ...
          __RANDVAR__57546316499699456150__ = 1;
        }
        break;
      case 1UL:
