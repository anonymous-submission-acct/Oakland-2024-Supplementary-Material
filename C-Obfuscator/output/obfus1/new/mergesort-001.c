...
unsigned long _1_entropy = 7591370474297715144UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i17 < 4) {
        ...
        p18->data = i17 * ((_1_entropy & 4) * (_1_entropy | 4) + (_1_entropy & ~4) * (~_1_entropy & 4));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i11 < 2) {
        ...
        p12->data = i11 * (((_1_entropy + 8) + 1UL) + ((-_1_entropy - 1UL) | (-8 - 1UL)));
