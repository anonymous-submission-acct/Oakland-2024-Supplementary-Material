...
unsigned long _2_entropy = 3080107002170801802UL;
...
void OBF_FUNC(char *str, unsigned int len) {
  ...
  char ch;
  char tmp;
  int __RANDVAR__41537825375788264661__;
  ...
  {
    {
      ...
      while (i17 < 4) {
        ...
        p18->data = i17 * (((_2_entropy & ~5) + (_2_entropy & ~5)) - (_2_entropy ^ 5));
    ...
    while (1) {
      ...
      case 12:;
        ...
        break;
      case 8:
        __RANDVAR__41537825375788264661__ = 0;
      ...
      case 34:;
        ...
        } else if ((((_2_alwaysZero & ((_2_entropy | 2) - (_2_entropy & 2))) * (_2_alwaysZero | ((_2_entropy | 2) - (_2_entropy & 2))) + (_2_alwaysZero & ~((_2_entropy | 2) - (_2_entropy & 2))) * (~_2_alwaysZero & ((_2_entropy | 2) - (_2_entropy & 2)))) - ~0) - 1UL) {
        } else {
      ...
      case 22:
        ...
        break;
      case 28:
        __RANDVAR__41537825375788264661__ = 1;
        _1_OBF_FUNC_next = 20UL;
        break;
      case 5:
      ...
      case 2:;
        ...
        break;
      case 20:;
        if (__RANDVAR__41537825375788264661__ == 0) {
