...
static __uint16_t __bswap_16(__uint16_t __bsx) { return __builtin_bswap16(__bsx); }
static __uint32_t __bswap_32(__uint32_t __bsx) { return __builtin_bswap32(__bsx); }
static __uint64_t __bswap_64(__uint64_t __bsx) { return __builtin_bswap64(__bsx); }
...
unsigned int OBF_FUNC(char *str, unsigned int len) { return (unsigned int)(*str); }
