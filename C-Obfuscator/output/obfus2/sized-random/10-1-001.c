...
unsigned long _2_entropy = 6771710662310842004UL;
struct _2_OBF_FUNC_1_opaque_NodeStruct {
  ...
  {
    {
      ...
      p15 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp;
      p15->next = p15;
      p15->prev = p15;
      ...
      while (i16 < 2) {
        ...
        p17 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___0;
        p17->data = (int)((unsigned long)i16 * ((_1_entropy & 10UL) * (_1_entropy | 10UL) + (_1_entropy & 0xfffffffffffffff5UL) * (~_1_entropy & 10UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p9 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___1;
      p9->next = p9;
      p9->prev = p9;
      ...
      while (i10 < 3) {
        ...
        p11 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___2;
        p11->data = (int)((unsigned long)i10 * (((_1_entropy - 4UL) - ((_1_entropy | 0xfffffffffffffffbUL) << 1UL)) - 2UL));
    ...
    _2_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i33 < 2) {
        ...
        p34->data = i33 * ((_2_entropy + ~10) + 1UL);
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i27 < 2) {
        ...
        p28->data = i27 * ((_2_entropy | 10) - (_2_entropy & 10));
    ...
    while (1) {
      ...
      case 15:
        ...
        break;
      case 31:
        localStaticState[0UL] = (unsigned int)(((unsigned long)input + 259792084UL) - 742538731UL) % 6U;
        _1_OBF_FUNC_next = 12UL;
        break;
      case 12:
        localStaticState[1UL] = 4U;
        _1_OBF_FUNC_next = 7UL;
        break;
      case 8:;
        return (_induction5_4_2);
        break;
      case 1:
        _induction1_0_2 = 0U;
