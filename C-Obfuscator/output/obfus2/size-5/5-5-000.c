...
struct _1_OBF_FUNC_argStruct {
  ...
  int __RANDVAR__47573004088154245738__;
  unsigned int *input;
...
void OBF_FUNC_FLATTEN_SPLIT_13(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab33:;
    if (!((_1_OBF_FUNC_arg->localStaticState[1UL] >> 4U) & 1U)) {
...
void OBF_FUNC_FLATTEN_SPLIT_24(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab38:
    _1_OBF_FUNC_arg->__RANDVAR__47573004088154245738__ = 1;
...
void OBF_FUNC_FLATTEN_SPLIT_25(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab28:
    _1_OBF_FUNC_arg->localStaticState[1UL] = (unsigned int)((unsigned long)*(_1_OBF_FUNC_arg->input) + 589765119UL);
...
void OBF_FUNC_FLATTEN_SPLIT_5(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab21:
    _1_OBF_FUNC_arg->localStaticState[(unsigned long)_1_OBF_FUNC_arg->_index0_9 % 2UL] += _1_OBF_FUNC_arg->localStaticState[(unsigned long)_1_OBF_FUNC_arg->_index0_9 % 2UL];
    { _1_OBF_FUNC_arg->_1_OBF_FUNC_next = 24UL; }
    return;
  }
}
...
void OBF_FUNC_FLATTEN_SPLIT_9(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab25:
    _1_OBF_FUNC_arg->localStaticState[0UL] = (unsigned int)(((unsigned long)*(_1_OBF_FUNC_arg->input) + 821628072UL) + 878588929UL);
...
void OBF_FUNC_FLATTEN_SPLIT_17(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab30:
    _1_OBF_FUNC_arg->__RANDVAR__47573004088154245738__ = 0;
    { _1_OBF_FUNC_arg->_1_OBF_FUNC_next = 9UL; }
    return;
  }
}
...
unsigned int OBF_FUNC(unsigned int input) {
  ...
  void (*_1_OBF_FUNC_jumpTab[45])(struct _1_OBF_FUNC_argStruct * _1_OBF_FUNC_arg) = {&OBF_FUNC_FLATTEN_SPLIT_3, &OBF_FUNC_FLATTEN_SPLIT_38, &OBF_FUNC_FLATTEN_SPLIT_3, &OBF_FUNC_FLATTEN_SPLIT_3, &OBF_FUNC_FLATTEN_SPLIT_7, &OBF_FUNC_FLATTEN_SPLIT_31, &OBF_FUNC_FLATTEN_SPLIT_27, &OBF_FUNC_FLATTEN_SPLIT_6, &OBF_FUNC_FLATTEN_SPLIT_37, &OBF_FUNC_FLATTEN_SPLIT_16, &OBF_FUNC_FLATTEN_SPLIT_11, &OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_3, &OBF_FUNC_FLATTEN_SPLIT_28, &OBF_FUNC_FLATTEN_SPLIT_12, &OBF_FUNC_FLATTEN_SPLIT_35, &OBF_FUNC_FLATTEN_SPLIT_2, &OBF_FUNC_FLATTEN_SPLIT_4, &OBF_FUNC_FLATTEN_SPLIT_19, &OBF_FUNC_FLATTEN_SPLIT_21, &OBF_FUNC_FLATTEN_SPLIT_39, &OBF_FUNC_FLATTEN_SPLIT_5, &OBF_FUNC_FLATTEN_SPLIT_32, &OBF_FUNC_FLATTEN_SPLIT_8, &OBF_FUNC_FLATTEN_SPLIT_14, &OBF_FUNC_FLATTEN_SPLIT_9, &OBF_FUNC_FLATTEN_SPLIT_40, &OBF_FUNC_FLATTEN_SPLIT_26, &OBF_FUNC_FLATTEN_SPLIT_25, &OBF_FUNC_FLATTEN_SPLIT_3, &OBF_FUNC_FLATTEN_SPLIT_17, &OBF_FUNC_FLATTEN_SPLIT_36, &OBF_FUNC_FLATTEN_SPLIT_10, &OBF_FUNC_FLATTEN_SPLIT_13, &OBF_FUNC_FLATTEN_SPLIT_29, &OBF_FUNC_FLATTEN_SPLIT_20, &OBF_FUNC_FLATTEN_SPLIT_34, &OBF_FUNC_FLATTEN_SPLIT_1, &OBF_FUNC_FLATTEN_SPLIT_24, &OBF_FUNC_FLATTEN_SPLIT_0, &OBF_FUNC_FLATTEN_SPLIT_30, &OBF_FUNC_FLATTEN_SPLIT_33, &OBF_FUNC_FLATTEN_SPLIT_23, &OBF_FUNC_FLATTEN_SPLIT_22, &OBF_FUNC_FLATTEN_SPLIT_18};
  {
    { _1_OBF_FUNC_arg._1_OBF_FUNC_next = 25UL; }
    _1_OBF_FUNC_arg.input = &input;
    while (1) {
      if (_1_OBF_FUNC_arg._1_OBF_FUNC_next > 44) {
...
void OBF_FUNC_FLATTEN_SPLIT_16(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab9:;
    if (_1_OBF_FUNC_arg->__RANDVAR__47573004088154245738__ == 0) {
...
void OBF_FUNC_FLATTEN_SPLIT_39(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab20:
    _1_OBF_FUNC_arg->localStaticState[(unsigned long)((int)_1_OBF_FUNC_arg->localStaticState[1UL]) % 2UL] = _1_OBF_FUNC_arg->localStaticState[1UL] * _1_OBF_FUNC_arg->localStaticState[1UL];
