...
unsigned long _1_entropy = 6200363105668353096UL;
...
int OBF_FUNC(char *a, char *b) {
  ...
  int c;
  int __RANDVAR__54183967326933814718__;
  int __RANDVAR__84905682554259170825__;
  int __RANDVAR__66889656923157833269__;
  ...
  int _2_OBF_FUNC__BARRIER_4;
  {
    ...
    c = 0;
    __RANDVAR__54183967326933814718__ = 0;
    while (__RANDVAR__54183967326933814718__ == 0) {
      if ((int)*(a + c) != 0) {
        (first[(int)*(a + c) - 97])++;
        c++;
      }
      ...
      __RANDVAR__54183967326933814718__ = 1;
    }
    c = 0;
    __RANDVAR__84905682554259170825__ = 0;
    while (__RANDVAR__84905682554259170825__ == 0) {
      if ((int)*(b + c) != 0) {
        (second[(int)*(b + c) - 97])++;
        c++;
      }
      ...
      while (1) {
        if (!((int)*(b + c) != 0)) {
          {
            if (_2_OBF_FUNC_2_opaque_ptr_1 != _2_OBF_FUNC_2_opaque_ptr_2) {
              i12 = main(__RANDVAR__54183967326933814718__, 0, 0);
            } else {
            }
            break;
          }
      ...
      __RANDVAR__84905682554259170825__ = 1;
    }
    c = 0;
    __RANDVAR__66889656923157833269__ = 0;
    while (__RANDVAR__66889656923157833269__ == 0) {
      if (c < 26) {
        if (first[c] != second[c]) {
          return (0);
        }
      ...
      __RANDVAR__66889656923157833269__ = 1;
    }
    return (1);
  }
}
