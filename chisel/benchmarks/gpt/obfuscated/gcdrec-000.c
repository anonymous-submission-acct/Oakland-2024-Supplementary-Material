...
unsigned long _1_entropy = 5613629357842207167UL;
...
int OBF_FUNC(int x, int y) {
  ...
  int tmp___53;
  int tmp___54;
  struct _2_OBF_FUNC_1_opaque_NodeStruct *p59;
  int i60;
  struct _2_OBF_FUNC_1_opaque_NodeStruct *p61;
  int _2_OBF_FUNC__BEGIN_1;
  int _2_OBF_FUNC__END_1;
  int _2_OBF_FUNC__BARRIER_2;
  struct _2_OBF_FUNC_2_opaque_NodeStruct *p65;
  int i66;
  struct _2_OBF_FUNC_2_opaque_NodeStruct *p67;
  ...
  {
    {
      ...
      p65 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
      p65->next = p65;
      p65->prev = p65;
      _2_OBF_FUNC_2_opaque_list_1 = p65;
      i66 = 0;
      while (i66 < 2) {
        p67 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p67->data = i66 * (((_1_entropy ^ ~2) + ((_1_entropy | 2) << 1UL)) + 1UL);
        p67->next = _2_OBF_FUNC_2_opaque_list_1->next;
        p67->prev = _2_OBF_FUNC_2_opaque_list_1;
        (_2_OBF_FUNC_2_opaque_list_1->next)->prev = p67;
        _2_OBF_FUNC_2_opaque_list_1->next = p67;
        i66++;
      }
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p59 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
      p59->next = p59;
      p59->prev = p59;
      _2_OBF_FUNC_1_opaque_list_1 = p59;
      i60 = 0;
      while (i60 < 2) {
        p61 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p61->data = i60 * ((_1_entropy ^ 1) + ((_1_entropy & 1) + (_1_entropy & 1)));
        p61->next = _2_OBF_FUNC_1_opaque_list_1->next;
        p61->prev = _2_OBF_FUNC_1_opaque_list_1;
        (_2_OBF_FUNC_1_opaque_list_1->next)->prev = p61;
        _2_OBF_FUNC_1_opaque_list_1->next = p61;
        i60++;
      }
    ...
    while (x != y) {
      ...
      if (x > y) {
        tmp___1 = OBF_FUNC(x - y, y);
        return (tmp___1);
      } else {
        tmp___2 = OBF_FUNC(x, y - x);
        return (tmp___2);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___5 = OBF_FUNC(x - y, y);
        return (tmp___5);
      } else {
        tmp___6 = OBF_FUNC(x, y - x);
        return (tmp___6);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___9 = OBF_FUNC(x - y, y);
        return (tmp___9);
      } else {
        tmp___10 = OBF_FUNC(x, y - x);
        return (tmp___10);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___12 = OBF_FUNC(x - y, y);
        return (tmp___12);
      } else {
        tmp___13 = OBF_FUNC(x, y - x);
        return (tmp___13);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___16 = OBF_FUNC(x - y, y);
        return (tmp___16);
      } else {
        tmp___17 = OBF_FUNC(x, y - x);
        return (tmp___17);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___20 = OBF_FUNC(x - y, y);
        return (tmp___20);
      } else {
        tmp___21 = OBF_FUNC(x, y - x);
        return (tmp___21);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___24 = OBF_FUNC(x - y, y);
        return (tmp___24);
      } else {
        tmp___25 = OBF_FUNC(x, y - x);
        return (tmp___25);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___27 = OBF_FUNC(x - y, y);
        return (tmp___27);
      } else {
        tmp___28 = OBF_FUNC(x, y - x);
        return (tmp___28);
      }
    }
    while (1) {
      ...
      if (x > y) {
        tmp___31 = OBF_FUNC(x - y, y);
        return (tmp___31);
      } else {
        tmp___32 = OBF_FUNC(x, y - x);
        return (tmp___32);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___35 = OBF_FUNC(x - y, y);
        return (tmp___35);
      } else {
        tmp___36 = OBF_FUNC(x, y - x);
        return (tmp___36);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___39 = OBF_FUNC(x - y, y);
        return (tmp___39);
      } else {
        tmp___40 = OBF_FUNC(x, y - x);
        return (tmp___40);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___42 = OBF_FUNC(x - y, y);
        return (tmp___42);
      } else {
        tmp___43 = OBF_FUNC(x, y - x);
        return (tmp___43);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___45 = OBF_FUNC(x - y, y);
        return (tmp___45);
      } else {
        tmp___46 = OBF_FUNC(x, y - x);
        return (tmp___46);
      }
    }
    while (x != y) {
      ...
      if (x > y) {
        tmp___48 = OBF_FUNC(x - y, y);
        return (tmp___48);
      } else {
        tmp___49 = OBF_FUNC(x, y - x);
        return (tmp___49);
      }
    }
    if ((((_1_alwaysZero & ((_1_entropy & ~10) - (~_1_entropy & 10))) * (_1_alwaysZero | ((_1_entropy & ~10) - (~_1_entropy & 10))) + (_1_alwaysZero & ~((_1_entropy & ~10) - (~_1_entropy & 10))) * (~_1_alwaysZero & ((_1_entropy & ~10) - (~_1_entropy & 10)))) - ~0) - 1UL) {
      while (1) {
        ...
        tmp___50 = rand();
        while ((tmp___50 % 10 >= 5) >= tmp___29) {
          return (tmp___20);
        }
        while ((x > y) <= tmp___43) {
          tmp___51 = OBF_FUNC(tmp___5, y + tmp___42);
          return (tmp___51 << 7);
        }
      }
    } else {
      while (x != y) {
        ...
        if (x > y) {
          tmp___51 = OBF_FUNC(x - y, y);
          return (tmp___51);
        } else {
          tmp___52 = OBF_FUNC(x, y - x);
          return (tmp___52);
        }
      }
    }
    while (x != y) {
      if (x > y) {
        tmp___53 = OBF_FUNC(x - y, y);
        return (tmp___53);
      } else {
        tmp___54 = OBF_FUNC(x, y - x);
        return (tmp___54);
      }
    }
    return (x);
...
// expanded variants: loop-fission, loop-fission, deadcode:bug
