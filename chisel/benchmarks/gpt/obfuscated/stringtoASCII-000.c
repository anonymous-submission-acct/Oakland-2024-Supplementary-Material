    ...
    {
      {
        ...
        {
          {
            _1_entropy = 407791329855683977UL;
  ...
  {
    {
      ...
      p10 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___0;
      p10->next = p10;
      p10->prev = p10;
      ...
      while (i11 < 4) {
        ...
        p12 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___1;
        p12->data = (int)((unsigned long)i11 * (((_1_entropy - 7UL) - ((_1_entropy | 0xfffffffffffffff8UL) << 1UL)) - 2UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p4 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___2;
      p4->next = p4;
      p4->prev = p4;
      ...
      while (i5 < 2) {
        ...
        p6 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___3;
        p6->data = (int)((unsigned long)i5 * ((_1_entropy & 3UL) * (_1_entropy | 3UL) + (_1_entropy & 0xfffffffffffffffcUL) * (~_1_entropy & 3UL)));
    ...
    while (1) {
      ...
      case 9:
        ...
        break;
      case 7:;
        if ((_1_alwaysZero & ((_1_entropy | 7UL) + (_1_entropy & 7UL))) * (_1_alwaysZero | ((_1_entropy | 7UL) + (_1_entropy & 7UL))) + (_1_alwaysZero & ~((_1_entropy | 7UL) + (_1_entropy & 7UL))) * (~_1_alwaysZero & ((_1_entropy | 7UL) + (_1_entropy & 7UL)))) {
          { _1_OBF_FUNC_next = 2UL; }
        } else {
...
// expanded variants: deadcode:True, flatten:switch
