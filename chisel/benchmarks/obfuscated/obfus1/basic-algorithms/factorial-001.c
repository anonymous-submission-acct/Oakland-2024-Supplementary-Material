...
unsigned long _2_entropy = 4085737251488077212UL;
  ...
  {
    {
      ...
      while (i12 < 4) {
        ...
        p13->data = i12 * (((_2_entropy + 8) + 1UL) + ((-_2_entropy - 1UL) | (-8 - 1UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i6 < 4) {
        ...
        p7->data = i6 * ((_2_entropy & 10) * (_2_entropy | 10) + (_2_entropy & ~10) * (~_2_entropy & 10));
