  ...
  {
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * (((_1_entropy + 10) + 1UL) + ((-_1_entropy - 1UL) | (-10 - 1UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8->data = i7 * ((_1_entropy | 9) - (_1_entropy & 9));
    ...
    while (1) {
      if (!(i <= n)) {
        {
          if ((((_1_alwaysZero & ((_1_entropy & ~9) + 9)) * (_1_alwaysZero | ((_1_entropy & ~9) + 9)) + (_1_alwaysZero & ~((_1_entropy & ~9) + 9)) * (~_1_alwaysZero & ((_1_entropy & ~9) + 9))) - ~1) - 1UL) {
