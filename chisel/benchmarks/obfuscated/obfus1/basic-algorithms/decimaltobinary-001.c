...
union __anonunion____missing_field_name_693862593;
struct __anonstruct___mbstate_t_297829523;
union __anonunion_pthread_rwlockattr_t_145707745;
struct __pthread_internal_slist;
union __anonunion_pthread_rwlock_t_656928968;
struct _2_OBF_FUNC_2_opaque_NodeStruct;
struct __pthread_internal_list;
union __anonunion____missing_field_name_692892721;
struct drand48_data;
...
typedef struct __anonstruct___mbstate_t_297829523 __mbstate_t;
...
struct __pthread_cond_s {
  union __anonunion____missing_field_name_693862593 __annonCompField1;
  union __anonunion____missing_field_name_692892721 __annonCompField2;
...
unsigned long _1_entropy = 7512817267700598181UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i14 < 2) {
        ...
        p15->data = i14 * ((_1_entropy | 6) + (_1_entropy & 6));
    ...
    while (1) {
      if (!(j > 0)) {
        if (((((_1_alwaysZero & ((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL))) * (_1_alwaysZero | ((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL))) + (_1_alwaysZero & ~((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL))) * (~_1_alwaysZero & ((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL)))) | 0) << 1UL) - (((_1_alwaysZero & ((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL))) * (_1_alwaysZero | ((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL))) + (_1_alwaysZero & ~((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL))) * (~_1_alwaysZero & ((_1_entropy ^ 4) + ((_1_entropy & 4) << 1UL)))) ^ 0)) {
          OBF_FUNC(j);
        } else {
        }
        break;
...
// variants: deadcode
// expanded variants: deadcode:call
