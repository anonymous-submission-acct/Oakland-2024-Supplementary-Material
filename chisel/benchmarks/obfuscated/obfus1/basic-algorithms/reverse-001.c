...
unsigned long _1_entropy = 4305457313861389203UL;
  ...
  {
    {
      ...
      while (i11 < 2) {
        ...
        p12->data = i11 * ((_1_entropy & 7) * (_1_entropy | 7) + (_1_entropy & ~7) * (~_1_entropy & 7));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i5 < 4) {
        ...
        p6->data = i5 * ((_1_entropy & 6) * (_1_entropy | 6) + (_1_entropy & ~6) * (~_1_entropy & 6));
    ...
    while (1) {
      {
        if ((((_1_alwaysZero & ((_1_entropy & ~6) - (~_1_entropy & 6))) * (_1_alwaysZero | ((_1_entropy & ~6) - (~_1_entropy & 6))) + (_1_alwaysZero & ~((_1_entropy & ~6) - (~_1_entropy & 6))) * (~_1_alwaysZero & ((_1_entropy & ~6) - (~_1_entropy & 6)))) ^ 0) + ((((_1_alwaysZero & ((_1_entropy & ~6) - (~_1_entropy & 6))) * (_1_alwaysZero | ((_1_entropy & ~6) - (~_1_entropy & 6))) + (_1_alwaysZero & ~((_1_entropy & ~6) - (~_1_entropy & 6))) * (~_1_alwaysZero & ((_1_entropy & ~6) - (~_1_entropy & 6)))) & 0) << 1UL)) {
        } else if (!n) {
          break;
        }
      }
