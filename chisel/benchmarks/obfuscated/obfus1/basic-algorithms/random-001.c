...
unsigned long _1_entropy = 8912190967139022599UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i12 < 3) {
        ...
        p13->data = i12 * (((_1_entropy + 2) + 1UL) + ((-_1_entropy - 1UL) | (-2 - 1UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i6 < 4) {
        ...
        p7->data = i6 * ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5));
