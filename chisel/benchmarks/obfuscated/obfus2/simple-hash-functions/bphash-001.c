...
unsigned long _2_entropy = 7540671925450892386UL;
  ...
  {
    {
      ...
      while (i16 < 2) {
        ...
        p17->data = i16 * (((_2_entropy + 2) + 1UL) + ((-_2_entropy - 1UL) | (-2 - 1UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i10 < 2) {
        ...
        p11->data = i10 * ((_2_entropy & 8) * (_2_entropy | 8) + (_2_entropy & ~8) * (~_2_entropy & 8));
    ...
    while (1) {
      ...
      case 17:
        ...
        if ((((_2_alwaysZero & ((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4)))) * (_2_alwaysZero | ((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4)))) + (_2_alwaysZero & ~((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4)))) * (~_2_alwaysZero & ((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4))))) | 1) + (((_2_alwaysZero & ((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4)))) * (_2_alwaysZero | ((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4)))) + (_2_alwaysZero & ~((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4)))) * (~_2_alwaysZero & ((_2_entropy ^ 4) - ((~_2_entropy & 4) + (~_2_entropy & 4))))) & 1)) {
          break;
        } else {
        }
      case 6:
