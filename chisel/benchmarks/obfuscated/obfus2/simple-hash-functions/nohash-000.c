...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  int __RANDVAR__93027708271733378784__;
  ...
  int _2_OBF_FUNC__BARRIER_4;
  {
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i5 < 4) {
        ...
        p6->data = i5 * ((_1_entropy & ~3) - (~_1_entropy & 3));
    ...
    __RANDVAR__93027708271733378784__ = 947;
    {
      if (((((_1_alwaysZero & ((_1_entropy - ~8) - 1UL)) * (_1_alwaysZero | ((_1_entropy - ~8) - 1UL)) + (_1_alwaysZero & ~((_1_entropy - ~8) - 1UL)) * (~_1_alwaysZero & ((_1_entropy - ~8) - 1UL))) ^ ~0) + ((((_1_alwaysZero & ((_1_entropy - ~8) - 1UL)) * (_1_alwaysZero | ((_1_entropy - ~8) - 1UL)) + (_1_alwaysZero & ~((_1_entropy - ~8) - 1UL)) * (~_1_alwaysZero & ((_1_entropy - ~8) - 1UL))) | 0) + (((_1_alwaysZero & ((_1_entropy - ~8) - 1UL)) * (_1_alwaysZero | ((_1_entropy - ~8) - 1UL)) + (_1_alwaysZero & ~((_1_entropy - ~8) - 1UL)) * (~_1_alwaysZero & ((_1_entropy - ~8) - 1UL))) | 0))) + 1UL) {
        __RANDVAR__93027708271733378784__ = main(i11, 0, 0);
      } else {
      }
