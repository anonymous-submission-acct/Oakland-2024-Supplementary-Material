...
unsigned long _1_entropy = 6065704974990928266UL;
...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  unsigned int hash;
  unsigned int i;
  int __RANDVAR__75680900558134122072__;
  ...
  {
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * ((_1_entropy | 1) + (_1_entropy & 1));
    ...
    if ((((_1_alwaysZero & ((_1_entropy & ~8) - (~_1_entropy & 8))) * (_1_alwaysZero | ((_1_entropy & ~8) - (~_1_entropy & 8))) + (_1_alwaysZero & ~((_1_entropy & ~8) - (~_1_entropy & 8))) * (~_1_alwaysZero & ((_1_entropy & ~8) - (~_1_entropy & 8)))) | 1) + (((_1_alwaysZero & ((_1_entropy & ~8) - (~_1_entropy & 8))) * (_1_alwaysZero | ((_1_entropy & ~8) - (~_1_entropy & 8))) + (_1_alwaysZero & ~((_1_entropy & ~8) - (~_1_entropy & 8))) * (~_1_alwaysZero & ((_1_entropy & ~8) - (~_1_entropy & 8)))) & 1)) {
    } else {
      i13 = main(i13, 0, 0);
    }
    hash = 1315423911U;
    i = 0U;
    __RANDVAR__75680900558134122072__ = 0;
    while (__RANDVAR__75680900558134122072__ == 0) {
      if (i < len) {
      ...
      }
      {
        if (_2_OBF_FUNC_1_opaque_ptr_1 == _2_OBF_FUNC_1_opaque_ptr_2) {
          ...
          __RANDVAR__75680900558134122072__ = main(i7, 0, 0);
        }
        if (i < len) {
          hash ^= ((hash << 5) + (unsigned int)*str) + (hash >> 2);
          str++;
      ...
      __RANDVAR__75680900558134122072__ = 1;
    }
    return (hash);
  }
}
// variants: loop-unroll, deadcode
// expanded variants: loop-unroll, deadcode:call
