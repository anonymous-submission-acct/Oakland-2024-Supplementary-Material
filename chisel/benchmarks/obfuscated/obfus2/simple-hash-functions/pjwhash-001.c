...
unsigned long _1_entropy = 3002408381950934388UL;
  ...
  {
    {
      ...
      while (i20 < 4) {
        ...
        p21->data = i20 * (((_1_entropy - 6) - ((_1_entropy | ~6) << 1UL)) - 2UL);
      ...
      if (test != 0U) {
        {
          if (_2_OBF_FUNC_1_opaque_ptr_1 != _2_OBF_FUNC_1_opaque_ptr_2) {
            ...
            BitsInUnsignedInt = OBF_FUNC(str, test);
          }
