...
unsigned long _2_entropy = 6063742069295812135UL;
  ...
  {
    {
      ...
      while (i16 < 2) {
        ...
        p17->data = i16 * (((_2_entropy + 6) + 1UL) + ((-_2_entropy - 1UL) | (-6 - 1UL)));
    ...
    while (1) {
      ...
      case 14:;
        if (i < len) {
          {
            if ((((_2_alwaysZero & (((_2_entropy + 7) + 1UL) + ((-_2_entropy - 1UL) | (-7 - 1UL)))) * (_2_alwaysZero | (((_2_entropy + 7) + 1UL) + ((-_2_entropy - 1UL) | (-7 - 1UL)))) + (_2_alwaysZero & ~(((_2_entropy + 7) + 1UL) + ((-_2_entropy - 1UL) | (-7 - 1UL)))) * (~_2_alwaysZero & (((_2_entropy + 7) + 1UL) + ((-_2_entropy - 1UL) | (-7 - 1UL))))) - ~0) - 1UL) {
            } else {
