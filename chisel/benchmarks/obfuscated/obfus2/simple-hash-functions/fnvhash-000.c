...
unsigned long _2_entropy = 2509325845900934468UL;
...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  ...
  unsigned int hash;
  unsigned int i;
  int __RANDVAR__56059134962727980587__;
  ...
  {
    {
      ...
      while (i15 < 2) {
        ...
        p16->data = i15 * (((_2_entropy - 5) - ((_2_entropy | ~5) + (_2_entropy | ~5))) - 2UL);
    ...
    while (1) {
      ...
      case 4:;
        ...
        break;
      case 30:
        __RANDVAR__56059134962727980587__ = 1;
      ...
      case 15:
        ...
        break;
      case 31:
        __RANDVAR__56059134962727980587__ = 0;
        _1_OBF_FUNC_next = 22UL;
        break;
      case 8:
        hash ^= (unsigned int)*str;
      ...
      case 34:
        ...
        break;
      case 22:;
        if (__RANDVAR__56059134962727980587__ == 0) {
