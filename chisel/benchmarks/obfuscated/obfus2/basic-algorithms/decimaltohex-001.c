...
unsigned long _1_entropy = 4608370420321964475UL;
  ...
  {
    {
      ...
      while (i25 < 2) {
        ...
        p26->data = i25 * (((_1_entropy - 9) - ((_1_entropy | ~9) + (_1_entropy | ~9))) - 2UL);
    ...
    while (quotient != 0L) {
      ...
      tmp___0 = i;
      i++;
      hexadecimalNumber[tmp___0] = (char)temp;
      quotient /= 16L;
    }
    while (quotient != 0L) {
      tmp___1 = rand();
      ...
      tmp___2 = i;
      i++;
      hexadecimalNumber[tmp___2] = (char)temp;
      quotient /= 16L;
    }
    while (quotient != 0L) {
      tmp___3 = rand();
    ...
    while (quotient != 0L) {
      ...
      tmp___5 = i;
      i++;
      hexadecimalNumber[tmp___5] = (char)temp;
      quotient /= 16L;
    }
...
// expanded variants: loop-fission, deadcode:call
