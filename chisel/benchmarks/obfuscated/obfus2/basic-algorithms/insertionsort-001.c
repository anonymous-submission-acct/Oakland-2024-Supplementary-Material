...
unsigned long _1_entropy = 7583065385202734169UL;
...
void OBF_FUNC(int *a, int n) {
  int __RANDVAR__29570011204027488534__;
  int __RANDVAR__33372921377258918798__;
  int __RANDVAR__78363661675292132950__;
  int __RANDVAR__65630576290988074180__;
  int __RANDVAR__10508822228495944428__;
  int i;
  int __RANDVAR__42221191140375222705__;
  int j;
  int __RANDVAR__21280282529331343993__;
  int __RANDVAR__10283124335531412277__;
  int temp;
  int __RANDVAR__84720079604113353451__;
  int __RANDVAR__9524456762508201878__;
  int __RANDVAR__53867011662399434139__;
  int __RANDVAR__5598492218101265925__;
  int __RANDVAR__9467949633410370715__;
  int __RANDVAR__73216677477894440431__;
  ...
  {
    {
      ...
      i27 = 0;
      while (i27 < 2) {
        p28 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p28->data = i27 * (((_1_entropy | 10) + (_1_entropy | 10)) - (_1_entropy ^ 10));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      i21 = 0;
      while (i21 < 2) {
        p22 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p22->data = i21 * ((_1_entropy & 9) * (_1_entropy | 9) + (_1_entropy & ~9) * (~_1_entropy & 9));
    ...
    __RANDVAR__29570011204027488534__++;
    if (__RANDVAR__29570011204027488534__ < (n - n) + 676) {
      __RANDVAR__33372921377258918798__ = __RANDVAR__29570011204027488534__;
    } else {
      __RANDVAR__78363661675292132950__ = 852 + (__RANDVAR__78363661675292132950__ - __RANDVAR__78363661675292132950__);
      if (__RANDVAR__78363661675292132950__ < 53) {
        {
          ...
          } else if (116 * __RANDVAR__78363661675292132950__ < 864) {
            n -= 627;
            n += 627;
          } else {
            __RANDVAR__65630576290988074180__ = 17871 + (n - __RANDVAR__65630576290988074180__);
          }
        }
      } else {
        __RANDVAR__10508822228495944428__ = 291080 - n * n;
      }
    }
    __RANDVAR__42221191140375222705__ -= n;
    __RANDVAR__21280282529331343993__ = (__RANDVAR__21280282529331343993__ - 221) + (502 + __RANDVAR__42221191140375222705__);
    if (__RANDVAR__21280282529331343993__ < 749 + (n - 160)) {
      __RANDVAR__10283124335531412277__ = 557;
    } else {
      __RANDVAR__42221191140375222705__ -= 920;
      __RANDVAR__42221191140375222705__ += 920;
    }
    i = 1;
    while (i < n) {
      if (_2_OBF_FUNC_1_opaque_ptr_1 != _2_OBF_FUNC_1_opaque_ptr_2) {
        temp = *(a + i);
        __RANDVAR__84720079604113353451__ = (__RANDVAR__84720079604113353451__ - 222) * __RANDVAR__84720079604113353451__;
      } else {
      }
      if (__RANDVAR__42221191140375222705__ * (__RANDVAR__84720079604113353451__ * 957) < n - 383400) {
        n -= 97;
        n += 97;
      } else {
        __RANDVAR__9524456762508201878__ = 940;
      }
      j = i - 1;
      while (1) {
        if (temp < *(a + j)) {
        ...
        if ((__RANDVAR__42221191140375222705__ * 907) * (488 - n) < 405) {
          __RANDVAR__53867011662399434139__ = (__RANDVAR__53867011662399434139__ + __RANDVAR__42221191140375222705__) - __RANDVAR__42221191140375222705__;
        } else if (__RANDVAR__42221191140375222705__ < 258) {
          __RANDVAR__5598492218101265925__ = 758;
        } else {
          __RANDVAR__42221191140375222705__ -= 210;
          __RANDVAR__42221191140375222705__ += 210;
        }
        *(a + (j + 1)) = *(a + j);
        j--;
    ...
    __RANDVAR__9467949633410370715__++;
    i = 0;
    while (i < n) {
      printf(" %d", *(a + i));
      __RANDVAR__73216677477894440431__ = 494;
      i++;
    }
    return;
  }
...
// expanded variants: irrelevant-code, deadcode:True
