...
unsigned long _2_entropy = 4711596655293076003UL;
...
int OBF_FUNC(int *a, int n, int m) {
  int i;
  int c;
  int __RANDVAR__7515204623580069493__;
  ...
  {
    {
      ...
      while (i15 < 4) {
        ...
        p16->data = i15 * ((_2_entropy & ~5) - (~_2_entropy & 5));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i9 < 2) {
        ...
        p10->data = i9 * (((_2_entropy - 2) - ((_2_entropy | ~2) << 1UL)) - 2UL);
      ...
      if (_3_OBF_FUNC_1_opaque_ptr_1 == _3_OBF_FUNC_1_opaque_ptr_2) {
        ...
        while (1) {
          ...
          case 1:
            ...
            break;
          case 3:
            __RANDVAR__7515204623580069493__ = 1;
            _1_OBF_FUNC_next = 42UL;
            break;
          case 16:
            __RANDVAR__7515204623580069493__ = 0;
            _1_OBF_FUNC_next = 42UL;
            break;
          case 21:;
            if (i < n) {
          ...
          case 37:;
            ...
            } else if ((((_2_alwaysZero & ((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4))) * (_2_alwaysZero | ((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4))) + (_2_alwaysZero & ~((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4))) * (~_2_alwaysZero & ((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4)))) | 0) + (((_2_alwaysZero & ((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4))) * (_2_alwaysZero | ((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4))) + (_2_alwaysZero & ~((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4))) * (~_2_alwaysZero & ((_2_entropy & 4) * (_2_entropy | 4) + (_2_entropy & ~4) * (~_2_entropy & 4)))) & 0)) {
            } else {
              _1_OBF_FUNC_next = 25UL;
            }
            break;
          ...
          case 10:
            ...
            break;
          case 42:;
            if (__RANDVAR__7515204623580069493__ == 0) {
