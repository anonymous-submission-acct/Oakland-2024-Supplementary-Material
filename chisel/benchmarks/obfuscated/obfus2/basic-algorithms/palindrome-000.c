    ...
    {
      {
        ...
        {
          {
            _2_entropy = 5790297203819170244UL;
  ...
  {
    {
      ...
      while (i13 < 4) {
        ...
        p14->data = (int)((unsigned long)i13 * ((_2_entropy & 4UL) * (_2_entropy | 4UL) + (_2_entropy & 0xfffffffffffffffbUL) * (~_2_entropy & 4UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 4) {
        ...
        p8->data = (int)((unsigned long)i7 * ((_2_entropy | 3UL) - (_2_entropy & 3UL)));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i29 < 3) {
        ...
        p30->data = i29 * (((_1_entropy - 4) - ((_1_entropy | ~4) << 1UL)) - 2UL);
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i23 < 3) {
        ...
        p24->data = i23 * (((_1_entropy - 10) - ((_1_entropy | ~10) + (_1_entropy | ~10))) - 2UL);
