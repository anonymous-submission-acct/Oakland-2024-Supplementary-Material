...
unsigned long _1_entropy = 171519706704425277UL;
...
int OBF_FUNC(int x, int y) {
  int __RANDVAR__17886629596336279651__;
  int tmp;
  int tmp___0;
  int tmp___1;
  int tmp___2;
  ...
  {
    {
      ...
      while (i23 < 2) {
        ...
        p24->data = i23 * ((_1_entropy & 9) * (_1_entropy | 9) + (_1_entropy & ~9) * (~_1_entropy & 9));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i17 < 2) {
        ...
        p18->data = i17 * (((_1_entropy - 1) - ((_1_entropy | ~1) + (_1_entropy | ~1))) - 2UL);
    ...
    __RANDVAR__17886629596336279651__ = 0;
    while (__RANDVAR__17886629596336279651__ == 0) {
      if (x != y) {
        if (x > y) {
          tmp = OBF_FUNC(x - y, y);
          return (tmp);
        } else {
          {
            if (_2_OBF_FUNC_1_opaque_ptr_1 == _2_OBF_FUNC_1_opaque_ptr_2) {
              tmp___6 = OBF_FUNC(tmp___3, __RANDVAR__17886629596336279651__);
            } else {
            }
      ...
      if (x != y) {
        if (x > y) {
          tmp___3 = OBF_FUNC(x - y, y);
          return (tmp___3);
        } else {
          tmp___4 = OBF_FUNC(x, y - x);
          return (tmp___4);
        }
      }
      while (x != y) {
        ...
        if (x != y) {
          if (x > y) {
            if (_2_OBF_FUNC_2_opaque_ptr_1 != _2_OBF_FUNC_2_opaque_ptr_2) {
              tmp___9 = OBF_FUNC(tmp___0, tmp___1);
            } else {
            }
            tmp___7 = OBF_FUNC(x - y, y);
            return (tmp___7);
          } else {
            tmp___8 = OBF_FUNC(x, y - x);
            return (tmp___8);
          }
        }
        if (x != y) {
      ...
      __RANDVAR__17886629596336279651__ = 1;
    }
    return (x);
  }
}
