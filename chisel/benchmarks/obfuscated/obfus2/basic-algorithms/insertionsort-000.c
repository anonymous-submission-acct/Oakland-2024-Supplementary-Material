...
unsigned long _2_entropy = 8042720760078011061UL;
  ...
  {
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = i13 * (((_2_entropy | 10) << 1UL) - (_2_entropy ^ 10));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8->data = i7 * ((_2_entropy & 1) * (_2_entropy | 1) + (_2_entropy & ~1) * (~_2_entropy & 1));
    ...
    while (1) {
      ...
      case 19:;
        ...
        break;
      case 17:
        _1_OBF_FUNC_jumpTab[17] = &OBF_FUNC_FLATTEN_SPLIT_3;
      ...
      case 20:
        _1_OBF_FUNC_jumpTab[15] = &OBF_FUNC_FLATTEN_SPLIT_0;
...
// variants: flatten, block-fission
// expanded variants: flatten:call, block-fission:default
