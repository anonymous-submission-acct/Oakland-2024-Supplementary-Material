...
unsigned long _1_entropy = 1267047347404242983UL;
  ...
  {
    {
      ...
      while (i14 < 3) {
        ...
        p15->data = i14 * ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5));
    ...
    while (i <= n / 2) {
      if (n % i == 0) {
        if (((((_1_alwaysZero & ((_1_entropy & ~2) + 2)) * (_1_alwaysZero | ((_1_entropy & ~2) + 2)) + (_1_alwaysZero & ~((_1_entropy & ~2) + 2)) * (~_1_alwaysZero & ((_1_entropy & ~2) + 2))) ^ ~1) + ((((_1_alwaysZero & ((_1_entropy & ~2) + 2)) * (_1_alwaysZero | ((_1_entropy & ~2) + 2)) + (_1_alwaysZero & ~((_1_entropy & ~2) + 2)) * (~_1_alwaysZero & ((_1_entropy & ~2) + 2))) | 1) + (((_1_alwaysZero & ((_1_entropy & ~2) + 2)) * (_1_alwaysZero | ((_1_entropy & ~2) + 2)) + (_1_alwaysZero & ~((_1_entropy & ~2) + 2)) * (~_1_alwaysZero & ((_1_entropy & ~2) + 2))) | 1))) + 1UL) {
          flag = 1;
        } else {
          flag = 1 & n;
        }
...
// variants: loop-fission, deadcode
// expanded variants: loop-fission, deadcode:bug
