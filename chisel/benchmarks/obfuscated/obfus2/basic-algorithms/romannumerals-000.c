...
unsigned long _1_entropy = 3049530494781625917UL;
...
int OBF_FUNC(int number) {
  int __RANDVAR__18151915738977779449__;
  int j;
  int __RANDVAR__28483274812419200274__;
  ...
  {
    {
      ...
      while (i12 < 2) {
        ...
        p13->data = i12 * (((_1_entropy + 10) + 1UL) + ((-_1_entropy - 1UL) | (-10 - 1UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i6 < 2) {
        ...
        p7->data = i6 * ((_1_entropy | 9) - (_1_entropy & 9));
    ...
    __RANDVAR__18151915738977779449__ = 0;
    while (__RANDVAR__18151915738977779449__ == 0) {
      if (number != 0) {
        if (number >= 1000) {
      ...
      if (number != 0) {
        if (number >= 1000) {
          ...
          if ((((_1_alwaysZero & (((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL)) * (_1_alwaysZero | (((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL)) + (_1_alwaysZero & ~(((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL)) * (~_1_alwaysZero & (((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL))) | 1) + (((_1_alwaysZero & (((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL)) * (_1_alwaysZero | (((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL)) + (_1_alwaysZero & ~(((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL)) * (~_1_alwaysZero & (((_1_entropy ^ ~10) + ((_1_entropy | 10) << 1UL)) + 1UL))) & 1)) {
            if (number < 400) {
              postdigits((char)'C', number / 100);
              number -= (number / 100) * 100;
            } else {
            ...
            while ((number < 400) <= __RANDVAR__28483274812419200274__) {
              postdigits((char)4, number / 100 + 3);
              number = (number - (number / 100) * 100) / __RANDVAR__18151915738977779449__;
            }
          }
        } else if (number >= 50) {
          if (number < 90) {
      ...
      if (number != 0) {
        if (number >= 1000) {
          ...
          if (number < 900) {
            {
              if ((((_1_alwaysZero & ((_1_entropy | 7) + (_1_entropy & 7))) * (_1_alwaysZero | ((_1_entropy | 7) + (_1_entropy & 7))) + (_1_alwaysZero & ~((_1_entropy | 7) + (_1_entropy & 7))) * (~_1_alwaysZero & ((_1_entropy | 7) + (_1_entropy & 7)))) ^ 1) + ((((_1_alwaysZero & ((_1_entropy | 7) + (_1_entropy & 7))) * (_1_alwaysZero | ((_1_entropy | 7) + (_1_entropy & 7))) + (_1_alwaysZero & ~((_1_entropy | 7) + (_1_entropy & 7))) * (~_1_alwaysZero & ((_1_entropy | 7) + (_1_entropy & 7)))) & 1) << 1UL)) {
                postdigits((char)'D', number / 500);
                number -= (number / 500) * 500;
              } else {
                postdigits((char)'D' * (char)9, number / 500 & __RANDVAR__18151915738977779449__);
                number = (number - (number / 500) * 500) >> j;
              }
            }
          } else {
            predigits((char)'C', (char)'M');
      ...
      __RANDVAR__18151915738977779449__ = 1;
    }
    printf("Roman number will be: ");
    j = 0;
    __RANDVAR__28483274812419200274__ = 0;
    while (__RANDVAR__28483274812419200274__ == 0) {
      if (j < i) {
      ...
      __RANDVAR__28483274812419200274__ = 1;
    }
    printf("\n");
    return (0);
  }
...
// variants: loop-unroll, deadcode
// expanded variants: loop-unroll, deadcode:bug
