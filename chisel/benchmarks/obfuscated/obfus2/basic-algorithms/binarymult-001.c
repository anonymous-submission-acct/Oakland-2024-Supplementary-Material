...
unsigned long _1_entropy = 1647386408825726496UL;
struct timespec {
  __time_t tv_sec;
    ...
    {
      {
        ...
        {
          {
            _2_entropy = 1893971714531468073UL;
  ...
  {
    {
      ...
      while (i15 < 3) {
        ...
        p16 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___1;
        p16->data = (int)((unsigned long)i15 * ((_2_entropy & 1UL) * (_2_entropy | 1UL) + (_2_entropy & 0xfffffffffffffffeUL) * (~_2_entropy & 1UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i9 < 3) {
        ...
        p10 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___3;
        p10->data = (int)((unsigned long)i9 * ((_2_entropy & 0xfffffffffffffff9UL) + 6UL));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i31 < 4) {
        ...
        p32->data = i31 * (((_1_entropy | 5) + (_1_entropy | 5)) - (_1_entropy ^ 5));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i25 < 2) {
        ...
        p26->data = i25 * (((_1_entropy + 9) + 1UL) + ((-_1_entropy - 1UL) | (-9 - 1UL)));
    ...
    {
      if ((((_1_alwaysZero & ((_1_entropy & ~7) + 7)) * (_1_alwaysZero | ((_1_entropy & ~7) + 7)) + (_1_alwaysZero & ~((_1_entropy & ~7) + 7)) * (~_1_alwaysZero & ((_1_entropy & ~7) + 7))) | 1) + (((_1_alwaysZero & ((_1_entropy & ~7) + 7)) * (_1_alwaysZero | ((_1_entropy & ~7) + 7)) + (_1_alwaysZero & ~((_1_entropy & ~7) + 7)) * (~_1_alwaysZero & ((_1_entropy & ~7) + 7))) & 1)) {
      } else {
        binary1 = OBF_FUNC(binary2, multiply);
      }
      _1_OBF_FUNC_next = 1UL;
    }
    while (1) {
      if ((((_2_alwaysZero & ((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL))) * (_2_alwaysZero | ((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL))) + (_2_alwaysZero & ~((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL))) * (~_2_alwaysZero & ((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL)))) ^ 1UL) + ((((_2_alwaysZero & ((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL))) * (_2_alwaysZero | ((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL))) + (_2_alwaysZero & ~((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL))) * (~_2_alwaysZero & ((_2_entropy & 9UL) * (_2_entropy | 9UL) + (_2_entropy & 0xfffffffffffffff6UL) * (~_2_entropy & 9UL)))) & 1UL) << 1UL)) {
        ...
        case 12UL:
          ...
          if (!((_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (_2_alwaysZero | ((_2_entropy | 10UL) - (_2_entropy & 10UL))) + (_2_alwaysZero & ~((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (~_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL))))) {
            break;
          }
        case 1UL:
          multiply = 0L;
        ...
        case 0UL:
          ...
          if (((((_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (_1_alwaysZero | (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) + (_1_alwaysZero & ~(((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (~_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL))) | 1) + (((_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (_1_alwaysZero | (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) + (_1_alwaysZero & ~(((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (~_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL))) | 1)) - (((_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (_1_alwaysZero | (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) + (_1_alwaysZero & ~(((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (~_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL))) ^ 1)) {
          } else {
            binary2 = OBF_FUNC(multiply, binary2);
          }
          break;
        case 7UL:
...
// expanded variants: block-fission:default, deadcode:call
