...
union __anonunion____missing_field_name_1040824294;
struct __anonstruct_ldiv_t_790849867;
struct __pthread_cond_s;
union __anonunion_pthread_cond_t_951761805;
struct timespec;
union __anonunion____missing_field_name_859993279;
union __anonunion_pthread_barrier_t_145707746;
struct __anonstruct___sigset_t_973126068;
struct __anonstruct___mbstate_t_458154409;
struct __pthread_internal_slist;
struct __anonstruct___g1_start32_1040824295;
struct drand48_data;
...
typedef struct __anonstruct___mbstate_t_458154409 __mbstate_t;
...
union __anonunion____missing_field_name_1040824294 {
  ...
  struct __anonstruct___g1_start32_1040824295 __g1_start32;
};
struct __pthread_cond_s {
  union __anonunion____missing_field_name_859993279 __annonCompField1;
  union __anonunion____missing_field_name_1040824294 __annonCompField2;
...
unsigned long _1_entropy = 4462815568551324045UL;
struct timespec {
  __time_t tv_sec;
    ...
    {
      {
        ...
        {
          {
            _2_entropy = 3559620073465294885UL;
  ...
  {
    {
      ...
      p16 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp;
      p16->next = p16;
      p16->prev = p16;
      ...
      while (i17 < 2) {
        ...
        p18 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___0;
        p18->data = (int)((unsigned long)i17 * ((_2_entropy & 5UL) * (_2_entropy | 5UL) + (_2_entropy & 0xfffffffffffffffaUL) * (~_2_entropy & 5UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p10 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___1;
      p10->next = p10;
      p10->prev = p10;
      ...
      while (i11 < 4) {
        ...
        p12 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___2;
        p12->data = (int)((unsigned long)i11 * ((_2_entropy ^ 5UL) + ((_2_entropy & 5UL) << 1UL)));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      p32->next = p32;
      p32->prev = p32;
      _2_OBF_FUNC_2_opaque_list_1 = p32;
      i33 = 0;
      while (i33 < 2) {
        p34 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p34->data = i33 * ((_1_entropy & 4) * (_1_entropy | 4) + (_1_entropy & ~4) * (~_1_entropy & 4));
        p34->next = _2_OBF_FUNC_2_opaque_list_1->next;
        p34->prev = _2_OBF_FUNC_2_opaque_list_1;
        (_2_OBF_FUNC_2_opaque_list_1->next)->prev = p34;
        _2_OBF_FUNC_2_opaque_list_1->next = p34;
        i33++;
      }
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p26->next = p26;
      p26->prev = p26;
      _2_OBF_FUNC_1_opaque_list_1 = p26;
      i27 = 0;
      while (i27 < 4) {
        p28 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p28->data = i27 * (((_1_entropy - 8) - ((_1_entropy | ~8) << 1UL)) - 2UL);
        p28->next = _2_OBF_FUNC_1_opaque_list_1->next;
        p28->prev = _2_OBF_FUNC_1_opaque_list_1;
        (_2_OBF_FUNC_1_opaque_list_1->next)->prev = p28;
        _2_OBF_FUNC_1_opaque_list_1->next = p28;
        i27++;
      }
    ...
    while (1) {
      ...
      case 29UL:;
        ...
        } else if (!(((((_2_alwaysZero & (((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL)) * (_2_alwaysZero | (((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL)) + (_2_alwaysZero & ~(((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL)) * (~_2_alwaysZero & (((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL))) ^ 0xffffffffffffffffUL) + (((_2_alwaysZero & (((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL)) * (_2_alwaysZero | (((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL)) + (_2_alwaysZero & ~(((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL)) * (~_2_alwaysZero & (((_2_entropy - 5UL) - ((_2_entropy | 0xfffffffffffffffaUL) + (_2_entropy | 0xfffffffffffffffaUL))) - 2UL))) << 1UL)) + 1UL)) {
          _1_OBF_FUNC_next = 21UL;
        }
        break;
      case 43UL:;
...
// expanded variants: block-fission:default, deadcode:True
