...
unsigned long _1_entropy = 8118090247196555805UL;
...
int OBF_FUNC(int x) {
  int n;
  int __RANDVAR__46767014145130082930__;
  int n1;
  int __RANDVAR__70223796880822739580__;
  int __RANDVAR__66291655117386435420__;
  int __RANDVAR__2949246539785243464__;
  int rem;
  int __RANDVAR__7169087957098561317__;
  int __RANDVAR__81856254770789922925__;
  int __RANDVAR__94465428016998360407__;
  int num;
  int __RANDVAR__22425065025856961298__;
  int __RANDVAR__2866017459688726591__;
  int __RANDVAR__6861671143626162083__;
  int __RANDVAR__19657073708405011667__;
  int __RANDVAR__38012852815790932517__;
  int __RANDVAR__7122461099390207898__;
  ...
  int _2_OBF_FUNC__BARRIER_4;
  {
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i20 < 4) {
        ...
        p21->data = i20 * ((_1_entropy & ~3) - (~_1_entropy & 3));
    ...
    __RANDVAR__46767014145130082930__ = 728;
    if (229235 + (727 - __RANDVAR__46767014145130082930__) < __RANDVAR__46767014145130082930__) {
      __RANDVAR__70223796880822739580__ = 211 * __RANDVAR__70223796880822739580__ - 253;
    } else {
      __RANDVAR__66291655117386435420__ = 120;
      if (x < x * 985) {
        __RANDVAR__2949246539785243464__ = 410;
      } else {
        __RANDVAR__46767014145130082930__ -= 798;
        __RANDVAR__46767014145130082930__ += 798;
      }
    }
    __RANDVAR__7169087957098561317__ += 531;
    if (__RANDVAR__46767014145130082930__ < 714) {
      __RANDVAR__7169087957098561317__ -= 972;
      __RANDVAR__7169087957098561317__ += 972;
    } else if (__RANDVAR__46767014145130082930__ < 83) {
      __RANDVAR__81856254770789922925__ *= __RANDVAR__81856254770789922925__ * x;
    } else {
      __RANDVAR__94465428016998360407__ = __RANDVAR__46767014145130082930__;
    }
    num = 0;
    n = x;
    __RANDVAR__46767014145130082930__ -= 461;
    __RANDVAR__46767014145130082930__ += 461;
    n1 = n;
    __RANDVAR__46767014145130082930__ -= 485;
    __RANDVAR__46767014145130082930__ += 485;
    while (n1 != 0) {
      rem = n1 % 10;
      if (__RANDVAR__46767014145130082930__ < (x + 923) * 607) {
        __RANDVAR__22425065025856961298__ = 243 + (x - 219);
        if (_2_OBF_FUNC_1_opaque_ptr_1 == _2_OBF_FUNC_1_opaque_ptr_2) {
          {
            if ((((_1_alwaysZero & ((_1_entropy | 3) - (_1_entropy & 3))) * (_1_alwaysZero | ((_1_entropy | 3) - (_1_entropy & 3))) + (_1_alwaysZero & ~((_1_entropy | 3) - (_1_entropy & 3))) * (~_1_alwaysZero & ((_1_entropy | 3) - (_1_entropy & 3)))) | 1) + (((_1_alwaysZero & ((_1_entropy | 3) - (_1_entropy & 3))) * (_1_alwaysZero | ((_1_entropy | 3) - (_1_entropy & 3))) + (_1_alwaysZero & ~((_1_entropy | 3) - (_1_entropy & 3))) * (~_1_alwaysZero & ((_1_entropy | 3) - (_1_entropy & 3)))) & 1)) {
            } else {
              rem = OBF_FUNC(__RANDVAR__2866017459688726591__);
            }
            __RANDVAR__81856254770789922925__ = main(n, 0, 0);
          }
        } else {
        }
        if (__RANDVAR__46767014145130082930__ < __RANDVAR__22425065025856961298__) {
          __RANDVAR__22425065025856961298__ -= 137;
          __RANDVAR__22425065025856961298__ += 137;
        } else if (x < x * (643 - __RANDVAR__46767014145130082930__)) {
          if (__RANDVAR__46767014145130082930__ + x * 124 < 858) {
            __RANDVAR__2866017459688726591__ = 397;
          } else {
            __RANDVAR__6861671143626162083__ = x;
          }
        } else {
          __RANDVAR__46767014145130082930__ += 538;
          __RANDVAR__46767014145130082930__ -= 538;
        }
      } else {
        x -= 368;
      ...
      num += (rem * rem) * rem;
      if (x - (x + 388) < 667) {
        __RANDVAR__19657073708405011667__ = 344;
        if (x < __RANDVAR__19657073708405011667__) {
          __RANDVAR__19657073708405011667__ += 938;
          __RANDVAR__19657073708405011667__ -= 938;
        } else {
          __RANDVAR__38012852815790932517__ = 774;
        }
      } else {
        __RANDVAR__7122461099390207898__ = 287 * x;
        if (x < 137) {
          x -= 11;
          x += 11;
        } else {
