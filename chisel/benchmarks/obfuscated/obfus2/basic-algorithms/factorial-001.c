...
unsigned long _1_entropy = 534092600000992833UL;
    ...
    {
      {
        ...
        {
          {
            _2_entropy = 2220840131119050135UL;
  ...
  {
    {
      ...
      while (i12 < 3) {
        ...
        p13->data = (int)((unsigned long)i12 * ((_2_entropy | 10UL) - (_2_entropy & 10UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i6 < 3) {
        ...
        p7->data = (int)((unsigned long)i6 * ((_2_entropy & 3UL) * (_2_entropy | 3UL) + (_2_entropy & 0xfffffffffffffffcUL) * (~_2_entropy & 3UL)));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i28 < 2) {
        ...
        p29->data = i28 * ((_1_entropy & 6) * (_1_entropy | 6) + (_1_entropy & ~6) * (~_1_entropy & 6));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i22 < 2) {
        ...
        p23->data = i22 * (((_1_entropy + 10) + 1UL) + ((-_1_entropy - 1UL) | (-10 - 1UL)));
    ...
    while (1) {
      ...
      case 7UL:;
        ...
        break;
      case 2UL:;
        if ((((_2_alwaysZero & ((_2_entropy - 0xfffffffffffffffaUL) - 1UL)) * (_2_alwaysZero | ((_2_entropy - 0xfffffffffffffffaUL) - 1UL)) + (_2_alwaysZero & ~((_2_entropy - 0xfffffffffffffffaUL) - 1UL)) * (~_2_alwaysZero & ((_2_entropy - 0xfffffffffffffffaUL) - 1UL))) | 1UL) + (((_2_alwaysZero & ((_2_entropy - 0xfffffffffffffffaUL) - 1UL)) * (_2_alwaysZero | ((_2_entropy - 0xfffffffffffffffaUL) - 1UL)) + (_2_alwaysZero & ~((_2_entropy - 0xfffffffffffffffaUL) - 1UL)) * (~_2_alwaysZero & ((_2_entropy - 0xfffffffffffffffaUL) - 1UL))) & 1UL)) {
          if (count <= n) {
