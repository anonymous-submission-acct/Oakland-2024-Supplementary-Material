...
unsigned long _1_entropy = 2721834349165593826UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i17 < 2) {
        ...
        p18->data = i17 * (((_1_entropy & ~5) << 1UL) - (_1_entropy ^ 5));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i11 < 4) {
        ...
        p12->data = i11 * ((_1_entropy & ~7) - (~_1_entropy & 7));
