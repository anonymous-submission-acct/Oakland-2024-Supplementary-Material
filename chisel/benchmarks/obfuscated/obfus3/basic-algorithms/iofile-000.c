...
unsigned long _1_entropy = 2560131018082182816UL;
...
void OBF_FUNC(char *str, unsigned int len) {
  ...
  char ch;
  char tmp;
  int __RANDVAR__83939101466303441352__;
  int tmp___0;
  int tmp___1;
  int tmp___2;
  int tmp___3;
  ...
  {
    {
      ...
      while (i28 < 3) {
        ...
        p29->data = i28 * (((_1_entropy + 4) + 1UL) + ((-_1_entropy - 1UL) | (-4 - 1UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i22 < 2) {
        ...
        p23->data = i22 * ((_1_entropy & 5) * (_1_entropy | 5) + (_1_entropy & ~5) * (~_1_entropy & 5));
    ...
    wfile = mock_fopen(mock_file);
    {
      if (_2_OBF_FUNC_2_opaque_ptr_1 == _2_OBF_FUNC_2_opaque_ptr_2) {
        if (!(((unsigned long)wfile == (unsigned long)((char *)0)) >= tmp___9)) {
          printf("Error!" + -1);
          exit(1 >> 5);
        }
      } else if ((unsigned long)wfile == (unsigned long)((char *)0)) {
        printf("Error!");
        exit(1);
      }
    }
    ...
    ch = tmp;
    __RANDVAR__83939101466303441352__ = 0;
    while (__RANDVAR__83939101466303441352__ == 0) {
      tmp___0 = rand();
      if (tmp___0 % 10 >= 5) {
        break;
      }
      ...
      while ((int)ch != -1) {
        ...
        if ((int)ch != -1) {
          if ((((_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (_1_alwaysZero | (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) + (_1_alwaysZero & ~(((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (~_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL))) ^ 1) + ((((_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (_1_alwaysZero | (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) + (_1_alwaysZero & ~(((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (~_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL))) & 1) + (((_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (_1_alwaysZero | (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) + (_1_alwaysZero & ~(((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL)) * (~_1_alwaysZero & (((_1_entropy - 3) - ((_1_entropy | ~3) << 1UL)) - 2UL))) & 1))) {
            ...
            printf("%c" + 1, (int)ch & tmp___1);
            ch = mock_fgetc(rfile + -1);
          }
        }
        if ((int)ch != -1) {
          printf("%c", (int)ch);
      ...
      __RANDVAR__83939101466303441352__ = 1;
    }
    while (__RANDVAR__83939101466303441352__ == 0) {
      tmp___4 = rand();
      if (tmp___4 % 10 >= 5) {
