...
unsigned long _2_entropy = 1110177998841070282UL;
struct _2_OBF_FUNC_1_opaque_NodeStruct {
    ...
    {
      {
        ...
        {
          {
            _1_entropy = 8151627785898879228UL;
...
long long OBF_FUNC(int n) {
  int count;
  long long factorial;
  int __RANDVAR__77606586839486969536__;
  ...
  {
    {
      ...
      while (i12 < 2) {
        ...
        p13->data = (int)((unsigned long)i12 * (((_1_entropy - 10UL) - ((_1_entropy | 0xfffffffffffffff5UL) << 1UL)) - 2UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i6 < 2) {
        ...
        p7->data = (int)((unsigned long)i6 * ((_1_entropy & 1UL) * (_1_entropy | 1UL) + (_1_entropy & 0xfffffffffffffffeUL) * (~_1_entropy & 1UL)));
    ...
    _2_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i29 < 4) {
        ...
        p30->data = i29 * ((_2_entropy | 7) - (_2_entropy & 7));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i23 < 4) {
        ...
        p24->data = i23 * (((_2_entropy - 8) - ((_2_entropy | ~8) + (_2_entropy | ~8))) - 2UL);
    ...
    while (1) {
      ...
      case 18:;
        ...
        break;
      case 25:
        __RANDVAR__77606586839486969536__ = 1;
      ...
      case 12:
        ...
        break;
      case 1:;
        if (__RANDVAR__77606586839486969536__ == 0) {
      ...
      case 19:;
        if (_3_OBF_FUNC_1_opaque_ptr_1 == _3_OBF_FUNC_1_opaque_ptr_2) {
          if (((((_1_alwaysZero & ((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL))) * (_1_alwaysZero | ((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL))) + (_1_alwaysZero & ~((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL))) * (~_1_alwaysZero & ((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL)))) | 1UL) << 1UL) - (((_1_alwaysZero & ((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL))) * (_1_alwaysZero | ((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL))) + (_1_alwaysZero & ~((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL))) * (~_1_alwaysZero & ((_1_entropy & 2UL) * (_1_entropy | 2UL) + (_1_entropy & 0xfffffffffffffffdUL) * (~_1_entropy & 2UL)))) ^ 1UL)) {
      ...
      case 10:;
        ...
        break;
      case 0:;
        if (((((_1_alwaysZero & ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) * (_1_alwaysZero | ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) + (_1_alwaysZero & ~((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) * (~_1_alwaysZero & ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL)))) ^ 0xffffffffffffffffUL) + (((_1_alwaysZero & ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) * (_1_alwaysZero | ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) + (_1_alwaysZero & ~((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) * (~_1_alwaysZero & ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL)))) + ((_1_alwaysZero & ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) * (_1_alwaysZero | ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) + (_1_alwaysZero & ~((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL))) * (~_1_alwaysZero & ((_1_entropy & 4UL) * (_1_entropy | 4UL) + (_1_entropy & 0xfffffffffffffffbUL) * (~_1_entropy & 4UL)))))) + 1UL) {
          _1_OBF_FUNC_next = 28UL;
        } else {
        ...
        break;
      case 7:
        __RANDVAR__77606586839486969536__ = 0;
        _1_OBF_FUNC_next = 1UL;
        break;
      case 29:
        factorial *= (long long)count;
...
// expanded variants: loop-unroll, deadcode:True, block-fission:default
