...
unsigned long _2_entropy = 4748727700899419443UL;
...
int OBF_FUNC(int n) {
  int i;
  int sum;
  int __RANDVAR__98790630903000277022__;
  int __RANDVAR__93784411088934886546__;
  int tmp;
  int tmp___0;
  int tmp___1;
  ...
  {
    {
      ...
      while (i17 < 2) {
        ...
        p18->data = i17 * ((_2_entropy & ~3) - (~_2_entropy & 3));
    ...
    while (1) {
      ...
      case 49:
        ...
        break;
      case 4:
        __RANDVAR__98790630903000277022__ = (__RANDVAR__98790630903000277022__ * __RANDVAR__98790630903000277022__) * (534 + __RANDVAR__98790630903000277022__);
      ...
      case 45:
        ...
        break;
      case 1:;
        if (n < (n - __RANDVAR__98790630903000277022__) + 639) {
        ...
        break;
      case 23:
        __RANDVAR__93784411088934886546__ = 308;
        _1_OBF_FUNC_next = 43UL;
        break;
      case 3:
        n -= 248;
