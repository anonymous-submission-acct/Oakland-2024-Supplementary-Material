...
unsigned long _1_entropy = 7419564567245385943UL;
struct timespec {
  __time_t tv_sec;
  ...
  {
    {
      ...
      while (i13 < 4) {
        ...
        p14->data = i13 * ((_1_entropy ^ 8) - ((~_1_entropy & 8) << 1UL));
    ...
    while (1) {
      ...
      case 17UL:;
        if (_2_OBF_FUNC_2_opaque_ptr_1 == _2_OBF_FUNC_2_opaque_ptr_2) {
        } else if (_1_OBF_FUNC_arg._1_OBF_FUNC_next > 20UL) {
      ...
      case 23UL:;
        ...
        break;
      case 3UL:
        _1_OBF_FUNC_jumpTab[3] = &OBF_FUNC_FLATTEN_SPLIT_14;
...
// expanded variants: flatten:call, flatten:switch, deadcode:True
