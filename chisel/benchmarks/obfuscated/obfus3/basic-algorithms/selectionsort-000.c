  ...
  {
    {
      ...
      while (i13 < 4) {
        ...
        p14->data = (int)((unsigned long)i13 * ((_1_entropy | 3UL) - (_1_entropy & 3UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8->data = (int)((unsigned long)i7 * ((_1_entropy | 7UL) - (_1_entropy & 7UL)));
    ...
    _2_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i30 < 2) {
        ...
        p31->data = (int)((unsigned long)i30 * ((_2_entropy & 4UL) * (_2_entropy | 4UL) + (_2_entropy & 0xfffffffffffffffbUL) * (~_2_entropy & 4UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i24 < 2) {
        ...
        p25->data = (int)((unsigned long)i24 * (((_2_entropy - 2UL) - ((_2_entropy | 0xfffffffffffffffdUL) << 1UL)) - 2UL));
    ...
    {
      {
        ...
        {
          {
            _2_entropy = 3201609851890866970UL;
