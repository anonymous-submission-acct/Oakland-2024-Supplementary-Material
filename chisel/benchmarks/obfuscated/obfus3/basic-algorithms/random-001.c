...
unsigned long _1_entropy = 9101341842601096065UL;
  ...
  {
    {
      ...
      while (i13 < 3) {
        ...
        p14 = (struct _3_OBF_FUNC_2_opaque_NodeStruct *)tmp___1;
        p14->data = (int)((unsigned long)i13 * ((_2_entropy | 2UL) - (_2_entropy & 2UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 2) {
        ...
        p8 = (struct _3_OBF_FUNC_1_opaque_NodeStruct *)tmp___3;
        p8->data = (int)((unsigned long)i7 * (((_2_entropy & 0xfffffffffffffffeUL) << 1UL) - (_2_entropy ^ 1UL)));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      p28->next = p28;
      p28->prev = p28;
      _2_OBF_FUNC_2_opaque_list_1 = p28;
      i29 = 0;
      while (i29 < 3) {
        p30 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p30->data = i29 * ((_1_entropy & ~3) - (~_1_entropy & 3));
        p30->next = _2_OBF_FUNC_2_opaque_list_1->next;
        p30->prev = _2_OBF_FUNC_2_opaque_list_1;
        (_2_OBF_FUNC_2_opaque_list_1->next)->prev = p30;
        _2_OBF_FUNC_2_opaque_list_1->next = p30;
        i29++;
      }
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p22->next = p22;
      p22->prev = p22;
      _2_OBF_FUNC_1_opaque_list_1 = p22;
      i23 = 0;
      while (i23 < 3) {
        p24 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p24->data = i23 * ((_1_entropy | 3) + (_1_entropy & 3));
        p24->next = _2_OBF_FUNC_1_opaque_list_1->next;
        p24->prev = _2_OBF_FUNC_1_opaque_list_1;
        (_2_OBF_FUNC_1_opaque_list_1->next)->prev = p24;
        _2_OBF_FUNC_1_opaque_list_1->next = p24;
        i23++;
      }
    ...
    while (1) {
      ...
      case 14UL:
        ...
        if ((((_1_alwaysZero & ((_1_entropy + ~6) + 1UL)) * (_1_alwaysZero | ((_1_entropy + ~6) + 1UL)) + (_1_alwaysZero & ~((_1_entropy + ~6) + 1UL)) * (~_1_alwaysZero & ((_1_entropy + ~6) + 1UL))) | 1) + (((_1_alwaysZero & ((_1_entropy + ~6) + 1UL)) * (_1_alwaysZero | ((_1_entropy + ~6) + 1UL)) + (_1_alwaysZero & ~((_1_entropy + ~6) + 1UL)) * (~_1_alwaysZero & ((_1_entropy + ~6) + 1UL))) & 1)) {
          break;
        } else {
        }
      case 12UL:
      ...
      case 16UL:
        ...
        break;
      case 11UL:;
        if (!(((((_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (_2_alwaysZero | ((_2_entropy | 10UL) - (_2_entropy & 10UL))) + (_2_alwaysZero & ~((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (~_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL)))) ^ 0xffffffffffffffffUL) + (((_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (_2_alwaysZero | ((_2_entropy | 10UL) - (_2_entropy & 10UL))) + (_2_alwaysZero & ~((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (~_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL)))) << 1UL)) + 1UL)) {
          if (c <= x) {
      ...
      case 5UL:
        printf("%d\n", n);
        if (!(((((_2_alwaysZero & ((_2_entropy | 4UL) - (_2_entropy & 4UL))) * (_2_alwaysZero | ((_2_entropy | 4UL) - (_2_entropy & 4UL))) + (_2_alwaysZero & ~((_2_entropy | 4UL) - (_2_entropy & 4UL))) * (~_2_alwaysZero & ((_2_entropy | 4UL) - (_2_entropy & 4UL)))) ^ 0xffffffffffffffffUL) + (((_2_alwaysZero & ((_2_entropy | 4UL) - (_2_entropy & 4UL))) * (_2_alwaysZero | ((_2_entropy | 4UL) - (_2_entropy & 4UL))) + (_2_alwaysZero & ~((_2_entropy | 4UL) - (_2_entropy & 4UL))) * (~_2_alwaysZero & ((_2_entropy | 4UL) - (_2_entropy & 4UL)))) + ((_2_alwaysZero & ((_2_entropy | 4UL) - (_2_entropy & 4UL))) * (_2_alwaysZero | ((_2_entropy | 4UL) - (_2_entropy & 4UL))) + (_2_alwaysZero & ~((_2_entropy | 4UL) - (_2_entropy & 4UL))) * (~_2_alwaysZero & ((_2_entropy | 4UL) - (_2_entropy & 4UL)))))) + 1UL)) {
    ...
    {
      {
        ...
        {
          {
            _2_entropy = 2170323625510215311UL;
...
// variants: irrelevant-code, block-fission, deadcode
// expanded variants: irrelevant-code, block-fission:default, deadcode:True
