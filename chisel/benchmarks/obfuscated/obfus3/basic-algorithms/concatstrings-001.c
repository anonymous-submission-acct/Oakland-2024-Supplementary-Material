...
unsigned long _1_entropy = 3232000804610397354UL;
struct timespec {
  __time_t tv_sec;
...
void OBF_FUNC(char *str1, char *str2) {
  ...
  int _2_OBF_FUNC__BARRIER_4;
  {
    ...
    _1_OBF_FUNC_jumpTab[17] = &&_1_OBF_FUNC_lab0;
    ...
    _1_OBF_FUNC_jumpTab[28] = &&_1_OBF_FUNC_lab0;
    ...
    _1_OBF_FUNC_jumpTab[42] = &&_1_OBF_FUNC_lab42;
    {
      ...
      while (i13 < 2) {
        ...
        p14->data = (int)((unsigned long)i13 * ((_2_entropy & 7UL) * (_2_entropy | 7UL) + (_2_entropy & 0xfffffffffffffff8UL) * (~_2_entropy & 7UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i7 < 3) {
        ...
        p8->data = (int)((unsigned long)i7 * ((_2_entropy & 0xfffffffffffffff5UL) + 10UL));
    ...
    _3_OBF_FUNC__BARRIER_2 = 1;
    {
      ...
      while (i31 < 2) {
        ...
        p32->data = i31 * ((_1_entropy & 6) * (_1_entropy | 6) + (_1_entropy & ~6) * (~_1_entropy & 6));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i25 < 3) {
        ...
        p26->data = i25 * (((_1_entropy - 7) - ((_1_entropy | ~7) + (_1_entropy | ~7))) - 2UL);
    ...
    goto *(_1_OBF_FUNC_jumpTab[_1_OBF_FUNC_next___0]);
  _1_OBF_FUNC_lab33:
  ...
  _1_OBF_FUNC_lab19:;
    if (((((_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (_2_alwaysZero | ((_2_entropy | 10UL) - (_2_entropy & 10UL))) + (_2_alwaysZero & ~((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (~_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL)))) ^ 0xffffffffffffffffUL) + (((_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (_2_alwaysZero | ((_2_entropy | 10UL) - (_2_entropy & 10UL))) + (_2_alwaysZero & ~((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (~_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL)))) + ((_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (_2_alwaysZero | ((_2_entropy | 10UL) - (_2_entropy & 10UL))) + (_2_alwaysZero & ~((_2_entropy | 10UL) - (_2_entropy & 10UL))) * (~_2_alwaysZero & ((_2_entropy | 10UL) - (_2_entropy & 10UL)))))) + 1UL) {
      goto _1_OBF_FUNC_lab2;
    } else {
...
int main(int argc, char **argv, char **_formal_envp) {
  ...
  _2_alwaysZero_i$nit_INLINE__2_alwaysZero_i$nit:
    _2_entropy = 899578245402355010UL;
...
// variants: block-fission, flatten, deadcode
// expanded variants: block-fission:default, flatten:goto, deadcode:True
