...
unsigned long _1_entropy = 1343898973539392645UL;
...
void OBF_FUNC(char *c, char ch) {
  int i;
  int count;
  int __RANDVAR__64777485720990406703__;
  int tmp;
  int tmp___0;
  int tmp___1;
  int tmp___2;
  int tmp___3;
  int tmp___4;
  int __RANDVAR__85749600890573529166__;
  int tmp___5;
  int tmp___6;
  int tmp___7;
  int tmp___8;
  int tmp___9;
  int tmp___10;
  int __RANDVAR__82356719546787739528__;
  int tmp___11;
  int tmp___12;
  int tmp___13;
  int tmp___14;
  ...
  {
    {
      ...
      p34->next = p34;
      p34->prev = p34;
      _2_OBF_FUNC_2_opaque_list_1 = p34;
      i35 = 0;
      while (i35 < 2) {
        p36 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
        p36->data = i35 * (((_1_entropy - 7) - ((_1_entropy | ~7) << 1UL)) - 2UL);
        p36->next = _2_OBF_FUNC_2_opaque_list_1->next;
        p36->prev = _2_OBF_FUNC_2_opaque_list_1;
        (_2_OBF_FUNC_2_opaque_list_1->next)->prev = p36;
        _2_OBF_FUNC_2_opaque_list_1->next = p36;
        i35++;
      }
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p28->next = p28;
      p28->prev = p28;
      _2_OBF_FUNC_1_opaque_list_1 = p28;
      i29 = 0;
      while (i29 < 2) {
        p30 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)malloc(sizeof(struct _2_OBF_FUNC_1_opaque_NodeStruct));
        p30->data = i29 * (((_1_entropy + 9) + 1UL) + ((-_1_entropy - 1UL) | (-9 - 1UL)));
        p30->next = _2_OBF_FUNC_1_opaque_list_1->next;
        p30->prev = _2_OBF_FUNC_1_opaque_list_1;
        (_2_OBF_FUNC_1_opaque_list_1->next)->prev = p30;
        _2_OBF_FUNC_1_opaque_list_1->next = p30;
        i29++;
      }
    ...
    i = 0;
    count = 0;
    __RANDVAR__64777485720990406703__ = 0;
    while (__RANDVAR__64777485720990406703__ == 0) {
      if ((int)*(c + i) != 0) {
        tmp = rand();
        if (tmp % 10 >= 5) {
          break;
      ...
      while ((int)*(c + i) != 0) {
        ...
        if ((int)*(c + i) != 0) {
          tmp___4 = rand();
          if ((((_1_alwaysZero & ((_1_entropy + ~4) + 1UL)) * (_1_alwaysZero | ((_1_entropy + ~4) + 1UL)) + (_1_alwaysZero & ~((_1_entropy + ~4) + 1UL)) * (~_1_alwaysZero & ((_1_entropy + ~4) + 1UL))) | 1) + (((_1_alwaysZero & ((_1_entropy + ~4) + 1UL)) * (_1_alwaysZero | ((_1_entropy + ~4) + 1UL)) + (_1_alwaysZero & ~((_1_entropy + ~4) + 1UL)) * (~_1_alwaysZero & ((_1_entropy + ~4) + 1UL))) & 1)) {
          } else {
            OBF_FUNC(c, ch);
          }
          if (tmp___4 % 10 >= 5) {
      ...
      __RANDVAR__64777485720990406703__ = 1;
    }
    __RANDVAR__85749600890573529166__ = 0;
    while (__RANDVAR__85749600890573529166__ == 0) {
      if ((int)*(c + i) != 0) {
        tmp___5 = rand();
        if (tmp___5 % 10 >= 5) {
          break;
      ...
      __RANDVAR__85749600890573529166__ = 1;
    }
    __RANDVAR__82356719546787739528__ = 0;
    while (__RANDVAR__82356719546787739528__ == 0) {
      if ((int)*(c + i) != 0) {
        tmp___11 = rand();
        if (tmp___11 % 10 >= 5) {
          break;
      ...
      __RANDVAR__82356719546787739528__ = 1;
    }
    __RANDVAR__57948883793909573362__ = 0;
    while (__RANDVAR__57948883793909573362__ == 0) {
      if ((int)*(c + i) != 0) {
        if ((int)ch == (int)*(c + i)) {
          count++;
        }
      ...
      __RANDVAR__57948883793909573362__ = 1;
    }
    tmp___17 = count;
    count++;
    printf("Frequency of %c = %d", (int)ch, tmp___17);
    return;
  }
}
void OBF_FUNC1(char *c, char ch) {
...
// expanded variants: loop-fission, loop-unroll, deadcode:call
