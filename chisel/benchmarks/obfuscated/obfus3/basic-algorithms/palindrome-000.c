...
int OBF_FUNC(int n) {
  ...
  int rem;
  int temp;
  int __RANDVAR__84162472373653290685__;
  int tmp;
  int tmp___0;
  int tmp___1;
  int tmp___2;
  ...
  {
    {
      ...
      while (i25 < 2) {
        ...
        p26->data = i25 * ((_1_entropy & 1) * (_1_entropy | 1) + (_1_entropy & ~1) * (~_1_entropy & 1));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i19 < 2) {
        ...
        p20->data = i19 * ((_1_entropy | 1) - (_1_entropy & 1));
    ...
    reverse = 0;
    temp = n;
    __RANDVAR__84162472373653290685__ = 0;
    while (__RANDVAR__84162472373653290685__ == 0) {
      tmp = rand();
      if (tmp % 10 >= 5) {
        break;
      }
      ...
      __RANDVAR__84162472373653290685__ = 1;
    }
    while (__RANDVAR__84162472373653290685__ == 0) {
      tmp___3 = rand();
      if (tmp___3 % 10 >= 5) {
    ...
    while (__RANDVAR__84162472373653290685__ == 0) {
      ...
      while (temp != 0) {
        if (temp != 0) {
          {
            if (((((_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (_1_alwaysZero | ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) + (_1_alwaysZero & ~((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (~_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10)))) | 1) + (((_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (_1_alwaysZero | ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) + (_1_alwaysZero & ~((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (~_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10)))) | 1)) - (((_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (_1_alwaysZero | ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) + (_1_alwaysZero & ~((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10))) * (~_1_alwaysZero & ((_1_entropy & 10) * (_1_entropy | 10) + (_1_entropy & ~10) * (~_1_entropy & 10)))) ^ 1)) {
              rem = temp % 10;
              reverse = reverse * 10 + rem;
              temp /= 10;
            } else {
              rem = __RANDVAR__84162472373653290685__;
              reverse = 4;
              temp = tmp___1;
            }
          }
