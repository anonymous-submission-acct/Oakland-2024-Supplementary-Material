...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  unsigned int hash;
  unsigned int i;
  int __RANDVAR__57478172586069780450__;
  int tmp;
  int tmp___0;
  int tmp___1;
  int tmp___2;
  ...
  int _2_OBF_FUNC__BARRIER_4;
  {
    ...
    hash = len;
    i = 0U;
    __RANDVAR__57478172586069780450__ = 0;
    while (__RANDVAR__57478172586069780450__ == 0) {
      tmp = rand();
      if (tmp % 10 >= 5) {
        break;
      }
      ...
      __RANDVAR__57478172586069780450__ = 1;
    }
    while (__RANDVAR__57478172586069780450__ == 0) {
      tmp___3 = rand();
      if (tmp___3 % 10 >= 5) {
    ...
    while (1) {
      if (_2_OBF_FUNC_2_opaque_ptr_1 != _2_OBF_FUNC_2_opaque_ptr_2) {
        if ((__RANDVAR__57478172586069780450__ == 0) != tmp___4) {
          return (hash);
        }
      } else if (!(__RANDVAR__57478172586069780450__ == 0)) {
        break;
      }
      tmp___7 = rand();
      if (tmp___7 % 10 >= 5) {
