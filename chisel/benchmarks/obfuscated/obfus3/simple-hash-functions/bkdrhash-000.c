...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  ...
  void *_1_OBF_FUNC_jumpTab[41] = {&&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab1, &&_1_OBF_FUNC_lab2, &&_1_OBF_FUNC_lab3, &&_1_OBF_FUNC_lab4, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab6, &&_1_OBF_FUNC_lab7, &&_1_OBF_FUNC_lab8, &&_1_OBF_FUNC_lab9, &&_1_OBF_FUNC_lab10, &&_1_OBF_FUNC_lab11, &&_1_OBF_FUNC_lab12, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab14, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab16, &&_1_OBF_FUNC_lab17, &&_1_OBF_FUNC_lab18, &&_1_OBF_FUNC_lab19, &&_1_OBF_FUNC_lab20, &&_1_OBF_FUNC_lab21, &&_1_OBF_FUNC_lab22, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab24, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab26, &&_1_OBF_FUNC_lab27, &&_1_OBF_FUNC_lab28, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab30, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab32, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab34, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab37, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab39, &&_1_OBF_FUNC_lab40};
  {
    {
      _2_OBF_FUNC__BEGIN_3 = 1;
      tmp___2 = malloc(sizeof(struct _2_OBF_FUNC_2_opaque_NodeStruct));
      p15 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___2;
      p15->next = p15;
      p15->prev = p15;
      ...
      while (i16 < 2) {
        ...
        p17 = (struct _2_OBF_FUNC_2_opaque_NodeStruct *)tmp___3;
        p17->data = (int)((unsigned long)i16 * ((_1_entropy & 0xfffffffffffffff5UL) + 10UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      p9 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___4;
      p9->next = p9;
      p9->prev = p9;
      ...
      while (i10 < 4) {
        ...
        p11 = (struct _2_OBF_FUNC_1_opaque_NodeStruct *)tmp___5;
        p11->data = (int)((unsigned long)i10 * ((_1_entropy & 0xfffffffffffffffcUL) - (~_1_entropy & 3UL)));
  ...
  _1_OBF_FUNC_lab34:
    tmp___0 = main(tmp, (char **)0, (char **)0);
  ...
  _1_OBF_FUNC_lab4:
    ...
    goto _1_OBF_FUNC_lab40;
  _1_OBF_FUNC_lab6:;
    if ((((_1_alwaysZero & ((_1_entropy & 8UL) * (_1_entropy | 8UL) + (_1_entropy & 0xfffffffffffffff7UL) * (~_1_entropy & 8UL))) * (_1_alwaysZero | ((_1_entropy & 8UL) * (_1_entropy | 8UL) + (_1_entropy & 0xfffffffffffffff7UL) * (~_1_entropy & 8UL))) + (_1_alwaysZero & ~((_1_entropy & 8UL) * (_1_entropy | 8UL) + (_1_entropy & 0xfffffffffffffff7UL) * (~_1_entropy & 8UL))) * (~_1_alwaysZero & ((_1_entropy & 8UL) * (_1_entropy | 8UL) + (_1_entropy & 0xfffffffffffffff7UL) * (~_1_entropy & 8UL)))) - 0xffffffffffffffffUL) - 1UL) {
