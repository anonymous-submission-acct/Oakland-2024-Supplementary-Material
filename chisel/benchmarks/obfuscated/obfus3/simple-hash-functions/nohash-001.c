    ...
    {
      {
        ...
        {
          {
            _2_entropy = 7655818788012499427UL;
...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  ...
  void *_1_OBF_FUNC_jumpTab[10] = {&&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab3, &&_1_OBF_FUNC_lab4, &&_1_OBF_FUNC_lab5, &&_1_OBF_FUNC_lab6, &&_1_OBF_FUNC_lab0, &&_1_OBF_FUNC_lab8, &&_1_OBF_FUNC_lab9};
  {
    {
      ...
      while (i11 < 4) {
        ...
        p12->data = (int)((unsigned long)i11 * (((_2_entropy | 10UL) + (_2_entropy | 10UL)) - (_2_entropy ^ 10UL)));
    ...
    _3_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i5 < 2) {
        ...
        p6->data = (int)((unsigned long)i5 * ((_2_entropy + 0xfffffffffffffffdUL) + 1UL));
  ...
  _1_OBF_FUNC_lab8:;
    if ((((_2_alwaysZero & (((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL))) * (_2_alwaysZero | (((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL))) + (_2_alwaysZero & ~(((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL))) * (~_2_alwaysZero & (((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL)))) | 1UL) + (((_2_alwaysZero & (((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL))) * (_2_alwaysZero | (((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL))) + (_2_alwaysZero & ~(((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL))) * (~_2_alwaysZero & (((_2_entropy + 2UL) + 1UL) + ((-_2_entropy - 1UL) | 0xfffffffffffffffdUL)))) & 1UL)) {
...
// variants: block-fission, irrelevant-code, flatten
// expanded variants: block-fission:default, irrelevant-code, flatten:goto
