...
unsigned long _1_entropy = 6233414353458813001UL;
...
unsigned int OBF_FUNC(char *str, unsigned int len) {
  ...
  int _2_OBF_FUNC__BARRIER_4;
  {
    ...
    _1_OBF_FUNC_jumpTab[38] = &&_1_OBF_FUNC_lab0;
...
// expanded variants: loop-fission, flatten:indirect-goto, deadcode:bug
