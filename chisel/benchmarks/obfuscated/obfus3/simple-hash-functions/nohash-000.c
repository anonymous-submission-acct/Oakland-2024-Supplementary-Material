  ...
  {
    {
      ...
      while (i10 < 2) {
        ...
        p11->data = (int)((unsigned long)i10 * ((_1_entropy & 0xfffffffffffffff5UL) + 10UL));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i4 < 4) {
        ...
        p5->data = (int)((unsigned long)i4 * ((_1_entropy & 0xfffffffffffffffcUL) - (~_1_entropy & 3UL)));
