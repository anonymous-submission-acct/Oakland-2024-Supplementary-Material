...
unsigned int OBF_FUNC(unsigned int input) {
  ...
  case 0UL:
    if (localStaticState[0UL] & 1) {
      _induction1_0_2 = 0UL;
      _index0_1 = 0UL;
      int __RANDVAR__68993751592060589726__ = 0;
      while (__RANDVAR__68993751592060589726__ == 0) {
        if ((rand() % 10) >= 5)
          break;
        if (_index0_1 < 1UL) {
        ...
        __RANDVAR__68993751592060589726__ = 1;
      }
      while (__RANDVAR__68993751592060589726__ == 0) {
        if ((rand() % 10) >= 5)
          break;
      ...
      if ((localStaticState[1UL] >> 1U) & 1) {
        ...
        if (localStaticState[1UL] & 1) {
          _induction3_2_2 = 0UL;
          _index2_0 = 0UL;
          int __RANDVAR__67438772883755654456__ = 0;
          while (__RANDVAR__67438772883755654456__ == 0) {
            if ((rand() % 10) >= 5)
              break;
            if (_index2_0 < 0UL) {
            ...
            __RANDVAR__67438772883755654456__ = 1;
          }
          while (__RANDVAR__67438772883755654456__ == 0) {
            if ((rand() % 10) >= 5)
              break;
      ...
      _induction5_4_2 = 0UL;
      _index4_9 = 0UL;
      int __RANDVAR__67211243196604663520__ = 0;
      while (__RANDVAR__67211243196604663520__ == 0) {
        if ((rand() % 10) >= 5)
          break;
        if (_index4_9 < 9UL) {
        ...
        __RANDVAR__67211243196604663520__ = 1;
      }
      while (__RANDVAR__67211243196604663520__ == 0) {
        if ((rand() % 10) >= 5)
          break;
