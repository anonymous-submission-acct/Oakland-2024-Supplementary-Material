...
unsigned long _1_entropy = 8131904654196855981UL;
  ...
  {
    {
      ...
      while (i30 < 2) {
        ...
        p31->data = i30 * (((_1_entropy + 10) + 1UL) + ((-_1_entropy - 1UL) | (-10 - 1UL)));
    ...
    _2_OBF_FUNC__BARRIER_4 = 1;
    {
      ...
      while (i24 < 4) {
        ...
        p25->data = i24 * ((_1_entropy & 7) * (_1_entropy | 7) + (_1_entropy & ~7) * (~_1_entropy & 7));
    ...
    case 0UL:
      if (!((localStaticState[1UL] >> 1U) & 1U)) {
        ...
        _index16_2 = 0U;
        while ((unsigned long)_index16_2 < 2UL) {
          _induction19_18_2 = 0U;
          _index18_0 = 0U;
          while ((unsigned long)_index18_0 < 0UL) {
    ...
    case 1UL:
      ...
      _induction1_0_2 = 0U;
      _index0_9 = 0U;
      while ((unsigned long)_index0_9 < 9UL) {
        _induction3_2_2 = 0U;
        _index2_0 = 0U;
      ...
      case 0UL:
        _induction9_8_2 = 0U;
        _index8_5 = 0U;
        while ((unsigned long)_index8_5 < 5UL) {
      ...
      case 1UL:
        _induction5_4_2 = 0U;
        _index4_4 = 0U;
        while ((unsigned long)_index4_4 < 4UL) {
        ...
        _index6_1 = 0U;
        {
          if ((((_1_alwaysZero & (((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9))) * (_1_alwaysZero | (((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9))) + (_1_alwaysZero & ~(((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9))) * (~_1_alwaysZero & (((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9)))) ^ 1) + ((((_1_alwaysZero & (((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9))) * (_1_alwaysZero | (((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9))) + (_1_alwaysZero & ~(((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9))) * (~_1_alwaysZero & (((_1_entropy | 9) << 1UL) - (_1_entropy ^ 9)))) & 1) << 1UL)) {
            while ((unsigned long)_index6_1 < 1UL) {
            ...
            while (1) {
              {
                while (((unsigned long)_index6_1 < 1UL) != i30) {
                }
              }
              localStaticState[(unsigned long)_induction7_6_2 % 2UL] = _induction13_12_2;
              _induction7_6_2 = (unsigned int)(((unsigned long)_induction7_6_2 + 1UL) % 2UL) - 6;
              _index6_1 = _index6_1;
            }
          }
        }
      ...
      _index10_2 = 0U;
      while ((unsigned long)_index10_2 < 2UL) {
        if (_2_OBF_FUNC_1_opaque_ptr_1 == _2_OBF_FUNC_1_opaque_ptr_2) {
          _induction13_12_2 = 10U;
          _index12_0 = _index10_2;
        } else {
          _induction13_12_2 = 0U;
          _index12_0 = 0U;
        }
        while ((unsigned long)_index12_0 < 0UL) {
          _induction15_14_2 = 0U;
          _index14_0 = 0U;
          while ((unsigned long)_index14_0 < 0UL) {
...
// variants: deadcode
// expanded variants: deadcode:bug
