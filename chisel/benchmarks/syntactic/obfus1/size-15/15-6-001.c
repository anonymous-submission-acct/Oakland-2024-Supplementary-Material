...
unsigned int OBF_FUNC(unsigned int input) {
  ...
  case 0UL:
    if (localStaticState[0UL] & 1) {
      _induction1_0_2 = 0UL;
      _index0_1 = 0UL;
      int __RANDVAR__45492615593471544894__ = 0;
      while (__RANDVAR__45492615593471544894__ == 0) {
        if (_index0_1 < 1UL) {
        ...
        __RANDVAR__45492615593471544894__ = 1;
      }
      if ((localStaticState[1UL] >> 1U) & 1) {
        ...
        if (localStaticState[1UL] & 1) {
          _induction3_2_2 = 0UL;
          _index2_0 = 0UL;
          int __RANDVAR__51495632839409317597__ = 0;
          while (__RANDVAR__51495632839409317597__ == 0) {
            if (_index2_0 < 0UL) {
            ...
            __RANDVAR__51495632839409317597__ = 1;
          }
        }
      }
    } else {
      _induction5_4_2 = 0UL;
      _index4_9 = 0UL;
      int __RANDVAR__40559747288443143743__ = 0;
      while (__RANDVAR__40559747288443143743__ == 0) {
        if (_index4_9 < 9UL) {
        ...
        __RANDVAR__40559747288443143743__ = 1;
      }
    }
    break;
  case 1UL:
