...
void OBF_FUNC_FLATTEN_SPLIT_23(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab19:
    _1_OBF_FUNC_arg->_index2_9 = (unsigned int)((unsigned long)_1_OBF_FUNC_arg->_index2_9 + 2UL);
...
void OBF_FUNC_FLATTEN_SPLIT_9(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab5:
    _1_OBF_FUNC_arg->localStaticState[_1_OBF_FUNC_arg->_index0_0] = _1_OBF_FUNC_arg->localStaticState[1UL] + _1_OBF_FUNC_arg->localStaticState[0UL];
...
unsigned int OBF_FUNC(unsigned int input) {
  ...
  void (*_1_OBF_FUNC_jumpTab[30])(struct _1_OBF_FUNC_argStruct * _1_OBF_FUNC_arg) = {&OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_16, &OBF_FUNC_FLATTEN_SPLIT_10, &OBF_FUNC_FLATTEN_SPLIT_13, &OBF_FUNC_FLATTEN_SPLIT_9, &OBF_FUNC_FLATTEN_SPLIT_4, &OBF_FUNC_FLATTEN_SPLIT_6, &OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_20, &OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_5, &OBF_FUNC_FLATTEN_SPLIT_14, &OBF_FUNC_FLATTEN_SPLIT_17, &OBF_FUNC_FLATTEN_SPLIT_18, &OBF_FUNC_FLATTEN_SPLIT_22, &OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_21, &OBF_FUNC_FLATTEN_SPLIT_1, &OBF_FUNC_FLATTEN_SPLIT_23, &OBF_FUNC_FLATTEN_SPLIT_0, &OBF_FUNC_FLATTEN_SPLIT_2, &OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_3, &OBF_FUNC_FLATTEN_SPLIT_12, &OBF_FUNC_FLATTEN_SPLIT_19, &OBF_FUNC_FLATTEN_SPLIT_11, &OBF_FUNC_FLATTEN_SPLIT_15, &OBF_FUNC_FLATTEN_SPLIT_8, &OBF_FUNC_FLATTEN_SPLIT_7};
  {
    { _1_OBF_FUNC_arg._1_OBF_FUNC_next = 26UL; }
    _1_OBF_FUNC_arg.input = &input;
    while (1) {
      if (_1_OBF_FUNC_arg._1_OBF_FUNC_next > 29) {
...
void OBF_FUNC_FLATTEN_SPLIT_1(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab18:;
    if ((unsigned long)_1_OBF_FUNC_arg->_index0_0 < 0UL) {
...
void OBF_FUNC_FLATTEN_SPLIT_17(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab13:
    _1_OBF_FUNC_arg->localStaticState[_1_OBF_FUNC_arg->_induction5_4_2] = _1_OBF_FUNC_arg->localStaticState[(unsigned long)((int)_1_OBF_FUNC_arg->localStaticState[1UL]) % 2UL] + _1_OBF_FUNC_arg->localStaticState[(unsigned long)((int)_1_OBF_FUNC_arg->localStaticState[1UL]) % 2UL];
...
void OBF_FUNC_FLATTEN_SPLIT_4(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab6:
    _1_OBF_FUNC_arg->localStaticState[(unsigned long)((int)_1_OBF_FUNC_arg->localStaticState[1UL]) % 2UL] = _1_OBF_FUNC_arg->localStaticState[0UL] - _1_OBF_FUNC_arg->localStaticState[(unsigned long)_1_OBF_FUNC_arg->_index2_9 % 2UL];
...
void OBF_FUNC_FLATTEN_SPLIT_16(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab2:;
    _1_OBF_FUNC_arg->_1_OBF_FUNC_return = (_1_OBF_FUNC_arg->localStaticState[0UL] + _1_OBF_FUNC_arg->localStaticState[1UL]) + 70288U;
...
void OBF_FUNC_FLATTEN_SPLIT_11(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab26:
    _1_OBF_FUNC_arg->localStaticState[0UL] = (unsigned int)(((unsigned long)*(_1_OBF_FUNC_arg->input) + 727910775UL) + 3707576828UL);
...
void OBF_FUNC_FLATTEN_SPLIT_13(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab4:
    _1_OBF_FUNC_arg->localStaticState[1UL] = (unsigned int)(((unsigned long)*(_1_OBF_FUNC_arg->input) + 784159696UL) - (261949459UL + (unsigned long)_1_OBF_FUNC_arg->localStaticState[0UL]));
...
void OBF_FUNC_FLATTEN_SPLIT_2(struct _1_OBF_FUNC_argStruct *_1_OBF_FUNC_arg) {
  {
  _1_OBF_FUNC_lab21:;
    if ((unsigned long)_1_OBF_FUNC_arg->_index2_9 < 9UL) {
